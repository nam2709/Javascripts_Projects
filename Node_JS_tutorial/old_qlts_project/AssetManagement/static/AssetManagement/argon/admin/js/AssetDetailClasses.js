...
class AssetAsset {
    ...
    tCreatePostApi() {
        ...
        $.ajax({
            url: "http://127.0.0.1:1500/AssetManagement/api/Asset/",
            type: "POST",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tUpdatePostApi(formId = null) {
        ...
        console.log(idForm)
        $.ajax({
            url: "http://127.0.0.1:1500/AssetManagement/api/Asset/" + idForm + "/",
            // type: "PUT",
            type: "PATCH",
            async: false,
            cache: false,
            ...
            success: function (data) {
                ...
                AssetAssetGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
    ...
    tDeleteApi(uuid = null) {
        ...
        $.ajax({
            url: "http://127.0.0.1:1500/AssetManagement/api/Asset/" + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: "http://127.0.0.1:1500/AssetManagement/api/Asset/" + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = AssetAsset_FILTER_URL;

            slugSearch = "&";

            if ($("#nameAssetAssetFilterSearchInputId").length > 0) {
                var value = $("#nameAssetAssetFilterSearchInputId").val();
                if (value != "" && value != null) {
    ...
    tGetObjApi(uuid) {
        ...
        this.callAjax =
            $.ajax({
                url: "http://127.0.0.1:1500/AssetManagement/api/Asset/" + uuid + "/",
                type: "GET",
                async: false,
                cache: false,
                timeout: 30000,
...
// add selected
$(document).ready(function () {
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/AssetType/", "Edit", "asset_type")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/OwnStatus/", "Edit", "own_status")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/WareHouseCategory/", "Edit", "warehouse")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/SupplierCategory/", "Edit", "supplier")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/AssetStatus/", "Edit", "asset_status")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/UnitCategory/", "Edit", "unit")
    SelectedFieldModal("http://127.0.0.1:1500/company/company/company/", "Edit", "owned_company")

    //Add
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/AssetType/", "Create", "asset_type")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/OwnStatus/", "Create", "own_status")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/WareHouseCategory/", "Create", "warehouse")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/SupplierCategory/", "Create", "supplier")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/AssetStatus/", "Create", "asset_status")
    SelectedFieldModal("http://127.0.0.1:1500/AssetManagement/api/UnitCategory/", "Create", "unit")
    SelectedFieldModal("http://127.0.0.1:1500/company/company/company/", "Create", "owned_company")
});
...
$(document).ready(function () {
    $("#assetAssetQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            AssetAssetSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    ...
    $("#assetAssetSearchBtnId").click(function () {
        ...
        AssetAssetSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search