...
var SupplierSupplier_arr_action = [
    // default action
    {
        "title": "Xem chi tiết",
        "func": "SupplierSupplierDetails",
        "icon": "far fa-eye",
        "href": "#",
        "isCheck": false,
    ...
    {
        "title": "Xóa",
        "func": "SupplierSupplierOnDeleteEvent",
...
// Actions functions
function SupplierSupplierDetails(uuid) {
    $('#SupplierSupplierDetailmodalsId').modal('toggle');
    var obj = new SupplierSupplier();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new SupplierSupplier(data).tFillFormModal('Detail', 'SupplierSupplierDetailModalsFormId');

    })
    //obj.tFillFormModal('Detail');
}

function SupplierSupplierEdit(uuid) {
    $('#SupplierSupplierEditmodalsId').modal('toggle');
    var obj = new SupplierSupplier();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new SupplierSupplier(data).tFillFormModal('Edit', 'SupplierSupplierEditModalsFormId');

    })
    //obj.tFillFormModal('Edit');
}

function SupplierSupplierOnDeleteEvent(uuid) {
    ...
    if (search_data == null) {
        ...
        SupplierSupplierOnDeleteWithDataSearchEvent(uuid);
    }

}
function SupplierSupplierOnDeleteWithDataSearchEvent(uuid) {
    $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?',
...
function SupplierSupplierViewDetail(selectionId) {
...
class SupplierSupplier {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            this.__model_name__ = "SupplierCategory";
            ...
            if (data.hasOwnProperty('uuid')) {
                this.uuid = data.uuid;
                this.editUrl = '/AssetManagement/SupplierCategory/edit/' + this.uuid + '/';
                this.detailUrl = '/AssetManagement/SupplierCategory/detail/' + this.uuid + '/';
            }
            else {
                // this.uuid = null;
            }
            ...
            if (data.hasOwnProperty('address')) {
                ...
                this.name_address = data.name_address;
            }
            else {
                // this.address = null;
            }
            ...
            if (data.hasOwnProperty('detail_address')) {
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameSupplierSupplierInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#uuidSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#codeSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buySupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#unitSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.unit = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#owned_companySupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_bySupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_bySupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#codeSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = $("#nameSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = $("#uuidSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = $("#price_buySupplierSupplierInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#unitSupplierSupplierInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#owned_companySupplierSupplierInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atSupplierSupplierInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_bySupplierSupplierInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_bySupplierSupplierInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_name = $("#nameSupplierSupplierInputId");
        ...
        try {
            var j_ele_uuid = $("#uuidSupplierSupplierInputId");
        ...
        try {
            var j_ele_tndid = $("#codeSupplierSupplierInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeSupplierSupplierInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        var self = this;
        try {
            var j_ele_name = $("#nameSupplierSupplier" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_code = $("#dcodeSupplierSupplier" + apart + "InputId");
        ...
        try {
            var j_ele_uuid = $("#uuidSupplierSupplier" + apart + "InputId");
        ...
        try {
            var j_ele_address = $("#addressSupplierSupplier" + apart + "InputId");
            if (j_ele_address.length > 0) {
                if (j_ele_address.attr('name') != 'uuid') {
                    j_ele_address.val(self.address).change();
                }
            }
            else {
                // j_ele_address.val(null);
            }
        }
        catch (err) {
            console.log('err = ', err);
        ...
        // Detail
        try {
            var j_ele_name_address = $("#name_addressSupplierSupplier" + apart + "InputId");
            if (j_ele_name_address.length > 0) {
                if (j_ele_name_address.attr('name') != 'uuid') {
                    j_ele_name_address.val(self.name_address).change();
                }
            }
            else {
                // j_ele_name_address.val(null);
            }
        }
        catch (err) {
            console.log('err = ', err);
        ...
        try {
            var j_ele_contact_info = $("#contact_infoSupplierSupplier" + apart + "InputId");
            if (j_ele_contact_info.length > 0) {
                if (j_ele_contact_info.attr('name') != 'uuid') {
                    j_ele_contact_info.val(self.contact_info).change();
                }
            }
            else {
                // j_ele_contact_info.val(null);
            }
        }
        catch (err) {
            console.log('err = ', err);
        ...
        try {
            var j_ele_detail_address = $("#detail_addressSupplierSupplier" + apart + "InputId");
            if (j_ele_detail_address.length > 0) {
                if (j_ele_detail_address.attr('name') != 'uuid') {
                    j_ele_detail_address.val(self.detail_address).change();
                }
            }
            else {
                // j_ele_detail_address.val(null);
            }
        }
        catch (err) {
            console.log('err = ', err);
        ...
        try {
            var j_ele_updated_at = $("#updated_atSupplierSupplier" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atSupplierSupplier" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_by = $("#created_bySupplierSupplier" + apart + "InputId");
    ...
    tCreatePostApi() {
        ...
        $.ajax({
            ...
            success: function (data) {
                self = new SupplierSupplier(data);
    ...
    tUpdatePostApi(formId = null) {
        ...
        var arr_table = [];
        if (formId == null) {
            formData = new FormData($('#SupplierSupplierCreateFormId')[0]);
        ...
        console.log(idForm)
        $.ajax({
            url: SupplierCategory_API_URL + idForm + "/",
            // type: "PUT",
            type: "PATCH",
            async: false,
            cache: false,
            ...
            success: function (data) {
                ...
                SupplierSupplierGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.warning('Mã kho nhà cung cấp tồn tại');
                console.log(xhr.status);
                console.log(thrownError);
                if (xhr.textStatus == 'timeout') {
                    this.tryCount++;
    ...
    tUpdateNewPostRowApi($this, form_data_parent = null, is_notice = false) {
        ...
        // 
        $.ajax({
            url: SupplierCategory_API_URL + uuid + "/",
            type: "PATCH",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tDeleteApi(uuid = null) {
        ...
        $.ajax({
            url: SupplierCategory_API_URL + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: SupplierCategory_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    if (data.hasOwnProperty('results')) {
                        for (var j = 0; j < data.results.length; j++) {
                            var tmp = new SupplierSupplier(data.results[j]);
                            results.push(tmp);
                        }
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = SupplierSupplier_FILTER_URL;

            slugSearch = "&";

            if ($("#nameSupplierSupplierFilterSearchInputId").length > 0) {
                var value = $("#nameSupplierSupplierFilterSearchInputId").val();
                if (value != "" && value != null) {
            ...
            SEARCH_URL = SupplierSupplier_Search_URL;

            slugSearch = "&";
            slugSearch += "search=" + $("#SupplierSupplierQuickSearchInputId").val();
        ...
        this.callAjax =
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var n_obj = new SupplierSupplier(data);
    ...
    tFillTable3(tableId = null, order = null) {
        var tbId = "SupplierSupplierDataTableId";
        if (tableId != null) {
            tbId = tableId;
        }

        if (order == null) {
            order = SUPPLIER_ID_TABLE_COUNT;
        }
        var table = $("#" + tbId);
        if (table.length > 0) {
            var html = "<tr>"
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if (attr == "name") {
                        html += `<td class="text-wrap" style="min-width:300px" onclick="SupplierSupplierDetails('` + this["uuid"] + `')"><a>` + (this[attr]) + `</a></td>`;
                        continue;
                    }
...
// fill table function
function SupplierSupplierGetDataTable(page = 1, search_data = null) {
    search_log["search_func"] = "SupplierSupplierGetDataTable";
    ...
    obj.callAjax.then(function (data) {
        $("#SupplierSupplierTableBodyId").empty();
        var body = $("#SupplierSupplierDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        SUPPLIER_ID_TABLE_COUNT = 1;
        var crr_record_in_page = AccountAccountrecord_in_page;

        if (page > 1) {
            SUPPLIER_ID_TABLE_COUNT = 1 + crr_record_in_page * page - crr_record_in_page
        }
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="SupplierSupplierGetDataTable(1)">Đầu</a></li>`);
            if (pagination["has_prev"] == true) {
                pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="SupplierSupplierGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
            }
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="SupplierSupplierGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "SupplierSupplierDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "SupplierSupplierDetailModalsFormId";
    SupplierSupplierViewDetail(selectionId)
})

// [Save Create] Clicked Handle function
$(document).ready(function () {
    $("#SupplierSupplierCreateModalBtnId").click(function () {
        var validate_obj = new InputValidation('SupplierSupplierCreateModalsFormId');
        if (validate_obj.validateRequired()) {
            toastr.warning('Vui lòng điền đầy đủ thông tin');
            return;
        }
        obj = new SupplierSupplier();
        console.log('Save obj = ', obj);
        obj.tCreateNewPostFormApi('SupplierSupplierCreateModalsFormId');
    })
});

// [SAVE UPDATE]
$(document).ready(function () {
    $("#SupplierSupplierUpdateModalBtnId").click(function () {
        obj = new SupplierSupplier();
        obj.tUpdatePostApi('SupplierSupplierEditModalsFormId');
    })
});

// add selected
$(document).ready(function () {
    SelectedFieldModal("http://127.0.0.1:1500/company/city/city/", "Edit", "address")

    //Add
    SelectedFieldModal("http://127.0.0.1:1500/company/city/city/", "Create", "address")
});
    ...
    for (var i = 1; i < 2; i++) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#" + InputId + "SupplierSupplier" + apart + "ModalInputId").append(html);
            }
        });
    }
}
...
// Export excel
$(document).ready(function () {
    $('#SupplierSupplierExportExcelBtnId').click(function () {
        // Define the columns to export
        var columnsToExport = [0, 1, 2, 3, 4]; // columns 1, 2, and 4 (zero-indexed)
        var theadToExport = '';
        $('#SupplierSupplierDataTableId thead').each(function () {
            var row = '';
        ...
        var tbodyToExport = '';
        $('#SupplierSupplierDataTableId tbody tr').each(function () {
            var row = '';
        ...
        $(tempTable).tableExport({
            filename: 'thông_tin_nhà_cung_cấp_%DD%-%MM%-%YY%',
            format: 'xls',
            escape: 'false',
...
function SupplierSupplierSearchData(page = 1, search_type, search_data = null) {
    search_log["search_func"] = "SupplierSupplierSearchData";
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="SupplierSupplierSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);

            if (pagination["has_prev"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="SupplierSupplierSearchData(` + (parseInt(pagination["current_page"]) - 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
            }
            pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
            if (pagination["has_next"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="SupplierSupplierSearchData(` + (parseInt(pagination["current_page"]) + 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="SupplierSupplierSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
        if (search_type == "quick") {
            var crr_txt = $("#SupplierSupplierQuickSearchInputId").val();
            highlight(crr_txt, "#SupplierSupplierTableBodyId");
        }
    })
...
$(document).ready(function () {
    $("#SupplierSupplierQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            SupplierSupplierSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    $("#SupplierSupplierQuickSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
    ...
    $("#SupplierSupplierSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
        ...
        SupplierSupplierSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search
