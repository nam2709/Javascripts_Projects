...
var CurrencyUnit_arr_action = [
    // default action
    {
        "title": "Xem chi tiết",
        "func": "CurrencyUnitDetails",
        "icon": "far fa-eye",
        "href": "#",
        "isCheck": false,
    ...
    {
        "title": "Xóa",
        "func": "CurrencyUnitOnDeleteEvent",
...
// Actions functions
function CurrencyUnitDetails(uuid) {
    $('#CurrencyUnitDetailmodalsId').modal('toggle');
    var obj = new CurrencyUnit();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new CurrencyUnit(data).tFillFormModal('Detail', 'CurrencyUnitDetailModalsFormId');

    })
    //obj.tFillFormModal('Detail');
}

function CurrencyUnitEdit(uuid) {
    $('#CurrencyUnitEditmodalsId').modal('toggle');
    var obj = new CurrencyUnit();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new CurrencyUnit(data).tFillFormModal('Edit', 'CurrencyUnitEditModalsFormId');

    })
    //obj.tFillFormModal('Edit');
}

function CurrencyUnitOnDeleteEvent(uuid) {
    ...
    if (search_data == null) {
        ...
        CurrencyUnitOnDeleteWithDataSearchEvent(uuid);
    }

}
function CurrencyUnitOnDeleteWithDataSearchEvent(uuid) {
    $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?',
...
function CurrencyUnitViewDetail(selectionId) {
...
class CurrencyUnit {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            this.__model_name__ = "CurrencyUnit";
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameCurrencyUnitInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#uuidCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#codeCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buyCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#CurrencyUnitUnitInputId");
            if (chEle.length > 0) {
                this.unit = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#owned_companyCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_byCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_byCurrencyUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#codeCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = $("#nameCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = $("#uuidCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = $("#price_buyCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#CurrencyUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#owned_companyCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_byCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_byCurrencyUnitInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_name = $("#nameCurrencyUnitInputId");
        ...
        try {
            var j_ele_uuid = $("#uuidCurrencyUnitInputId");
        ...
        try {
            var j_ele_tndid = $("#codeCurrencyUnitInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeCurrencyUnitInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        var self = this;
        try {
            var j_ele_name = $("#nameCurrencyUnit" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_code = $("#dcodeCurrencyUnit" + apart + "InputId");
        ...
        try {
            var j_ele_uuid = $("#uuidCurrencyUnit" + apart + "InputId");
        ...
        try {
            var j_ele_updated_at = $("#updated_atCurrencyUnit" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atCurrencyUnit" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_name = $("#created_byCurrencyUnit" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
                    j_ele_name.val(self.created_by).change();
                }
            }
            else {
                // j_ele_name.val(null);
    ...
    tUpdatePostApi(formId = null) {
        ...
        var arr_table = [];
        if (formId == null) {
            formData = new FormData($('#CurrencyUnitCreateFormId')[0]);
        ...
        console.log(idForm)
        $.ajax({
            url: CurrencyUnit_API_URL + idForm + "/",
            // type: "PUT",
            type: "PATCH",
            async: false,
            cache: false,
            ...
            success: function (data) {
                ...
                CurrencyUnitGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.warning('Mã kho đơn vị tính tồn tại');
                console.log(xhr.status);
                console.log(thrownError);
                if (xhr.textStatus == 'timeout') {
                    this.tryCount++;
    ...
    tDeleteApi(uuid = null) {
        ...
        $.ajax({
            url: CurrencyUnit_API_URL + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: CurrencyUnit_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    if (data.hasOwnProperty('results')) {
                        for (var j = 0; j < data.results.length; j++) {
                            var tmp = new CurrencyUnit(data.results[j]);
                            results.push(tmp);
                        }
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = CurrencyUnit_FILTER_URL;

            slugSearch = "&";

            if ($("#nameCurrencyUnitFilterSearchInputId").length > 0) {
                var value = $("#nameCurrencyUnitFilterSearchInputId").val();
                if (value != "" && value != null) {
            ...
            SEARCH_URL = CurrencyUnit_Search_URL;

            slugSearch = "&";
            slugSearch += "search=" + $("#CurrencyUnitQuickSearchInputId").val();
        ...
        this.callAjax =
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var n_obj = new CurrencyUnit(data);
    ...
    tFillTable3(tableId = null, order = null) {
        var tbId = "CurrencyUnitDataTableId";
        if (tableId != null) {
            tbId = tableId;
        }

        if (order == null) {
            order = CurrencyUnit_ID_TABLE_COUNT;
        }
        var table = $("#" + tbId);
        if (table.length > 0) {
            var html = "<tr>"
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if (attr == "name") {
                        html += `<td class="text-wrap" style="min-width:300px" onclick="CurrencyUnitDetails('` + this["uuid"] + `')"><a>` + (this[attr]) + `</a></td>`;
                        continue;
                    }
...
// fill table function
function CurrencyUnitGetDataTable(page = 1, search_data = null) {
    search_log["search_func"] = "CurrencyUnitGetDataTable";
    ...
    obj.callAjax.then(function (data) {
        $("#CurrencyUnitTableBodyId").empty();
        var body = $("#CurrencyUnitDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        CurrencyUnit_ID_TABLE_COUNT = 1;
        var crr_record_in_page = AccountAccountrecord_in_page;

        if (page > 1) {
            CurrencyUnit_ID_TABLE_COUNT = 1 + crr_record_in_page * page - crr_record_in_page
        }
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="CurrencyUnitGetDataTable(1)">Đầu</a></li>`);
            if (pagination["has_prev"] == true) {
                pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="CurrencyUnitGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
            }
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="CurrencyUnitGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "CurrencyUnitDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "CurrencyUnitDetailModalsFormId";
    CurrencyUnitViewDetail(selectionId)
})

// [Save Create] Clicked Handle function
$(document).ready(function () {
    $("#CurrencyUnitCreateModalBtnId").click(function () {
        var validate_obj = new InputValidation('CurrencyUnitCreateModalsFormId');
        if (validate_obj.validateRequired()) {
            toastr.warning('Vui lòng điền đầy đủ thông tin');
            return;
        }
        obj = new CurrencyUnit();
        console.log('Save obj = ', obj);
        obj.tCreateNewPostFormApi('CurrencyUnitCreateModalsFormId');
    })
});

// [SAVE UPDATE]
$(document).ready(function () {
    $("#CurrencyUnitUpdateModalBtnId").click(function () {
        obj = new CurrencyUnit();
        obj.tUpdatePostApi('CurrencyUnitEditModalsFormId');
    })
});

// Export excel
$(document).ready(function () {
    $('#CurrencyUnitExportExcelBtnId').click(function () {
        // Define the columns to export
        var columnsToExport = [0, 1, 2]; // columns 1, 2, and 4 (zero-indexed)
        var theadToExport = '';
        $('#CurrencyUnitDataTableId thead').each(function () {
            var row = '';
        ...
        var tbodyToExport = '';
        $('#CurrencyUnitDataTableId tbody tr').each(function () {
            var row = '';
        ...
        $(tempTable).tableExport({
            filename: 'thông_tin_đơn_vị_tiền_tệ_%DD%-%MM%-%YY%',
            format: 'xls',
            escape: 'false',
...
function CurrencyUnitSearchData(page = 1, search_type, search_data = null) {
    search_log["search_func"] = "CurrencyUnitSearchData";
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="CurrencyUnitSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);

            if (pagination["has_prev"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="CurrencyUnitSearchData(` + (parseInt(pagination["current_page"]) - 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
            }
            pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
            if (pagination["has_next"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="CurrencyUnitSearchData(` + (parseInt(pagination["current_page"]) + 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="CurrencyUnitSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
        if (search_type == "quick") {
            var crr_txt = $("#CurrencyUnitQuickSearchInputId").val();
            highlight(crr_txt, "#CurrencyUnitTableBodyId");
        }
    })
...
$(document).ready(function () {
    $("#CurrencyUnitQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            CurrencyUnitSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    $("#CurrencyUnitQuickSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
    ...
    $("#CurrencyUnitSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
        ...
        CurrencyUnitSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search
...
function CheckUnique(dcode) {
    ...
    $.ajax({
        url: CurrencyUnit_Search_URL + slugSearch,
        dataType: 'JSON',
        type: 'GET',
        success: function (data) {
            if (data.results.length > 0) {
