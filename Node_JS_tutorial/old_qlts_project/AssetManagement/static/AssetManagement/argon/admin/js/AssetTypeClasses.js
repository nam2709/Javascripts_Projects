...
var AssetType_arr_action = [
    // default action
    {
        "title": "Xem chi tiết",
        "func": "AssetTypeDetails",
        "icon": "far fa-eye",
        "href": "#",
        "isCheck": false,
...
// Actions functions
function AssetTypeDetails(uuid) {
    $('#AssetTypeDetailmodalsId').modal('toggle');
    var obj = new AssetType();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new AssetType(data).tFillFormModal('Detail', 'AssetTypeDetailModalsFormId');

    })
    //obj.tFillFormModal('Detail');
}

function AssetTypeEdit(uuid) {
    $('#AssetTypeEditmodalsId').modal('toggle');
    var obj = new AssetType();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new AssetType(data).tFillFormModal('Edit', 'AssetTypeEditModalsFormId');

    })
    //obj.tFillFormModal('Edit');
}

function AssetTypeOnDeleteEvent(uuid) {
    ...
    if (search_data == null) {
        ...
        AssetTypeOnDeleteWithDataSearchEvent(uuid);
    }

}
function AssetTypeOnDeleteWithDataSearchEvent(uuid) {
    $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?',
...
function AssetTypeViewDetail(selectionId) {
...
class AssetType {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            if (data.hasOwnProperty('asset_of_type')) {
                this.asset_of_type = data.asset_of_type;
                this.name_asset_of_type = data.name_asset_of_type;
            }
            else {
                // this.asset_of_type = null;
            }
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameAssetTypeInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#uuidAssetTypeInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#codeAssetTypeInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buyAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#unitAssetTypeInputId");
            if (chEle.length > 0) {
                this.unit = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#owned_companyAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_byAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_byAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#codeAssetTypeInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = $("#nameAssetTypeInputId");
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = $("#uuidAssetTypeInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = $("#price_buyAssetTypeInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedAssetTypeInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeAssetTypeInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseAssetTypeInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierAssetTypeInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusAssetTypeInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusAssetTypeInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#unitAssetTypeInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#owned_companyAssetTypeInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atAssetTypeInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atAssetTypeInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_byAssetTypeInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_byAssetTypeInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_name = $("#nameAssetTypeInputId");
        ...
        try {
            var j_ele_uuid = $("#uuidAssetTypeInputId");
        ...
        try {
            var j_ele_tndid = $("#codeAssetTypeInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeAssetTypeInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        var self = this;
        try {
            var j_ele_name = $("#nameAssetType" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_code = $("#dcodeAssetType" + apart + "InputId");
        ...
        try {
            var j_ele_uuid = $("#uuidAssetType" + apart + "InputId");
        ...
        try {
            var j_ele_asset_of_type = $("#asset_of_typeAssetType" + apart + "InputId");
            if (j_ele_asset_of_type.length > 0) {
                if (j_ele_asset_of_type.attr('name') != 'uuid') {
                    j_ele_asset_of_type.val(self.asset_of_type).change();
                }
            }
            else {
                // j_ele_nick_name.val(null);
        ...
        // fill modal detail`
        try {
            var j_ele_asset_of_type = $("#name_asset_of_typeAssetType" + apart + "InputId");
            if (j_ele_asset_of_type.length > 0) {
                if (j_ele_asset_of_type.attr('name') != 'uuid') {
                    j_ele_asset_of_type.val(self.name_asset_of_type).change();
                }
            }
            else {
                // j_ele_nick_name.val(null);
        ...
        try {
            var j_ele_updated_at = $("#updated_atAssetType" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atAssetType" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_by = $("#created_byAssetType" + apart + "InputId");
    ...
    tUpdatePostApi(formId = null) {
        ...
        var arr_table = [];
        if (formId == null) {
            formData = new FormData($('#AssetTypeCreateFormId')[0]);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                AssetTypeGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.warning('Mã loại tài sản đã tồn tại');
                console.log(xhr.status);
                console.log(thrownError);
                if (xhr.textStatus == 'timeout') {
                    this.tryCount++;
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: AssetType_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    if (data.hasOwnProperty('results')) {
                        for (var j = 0; j < data.results.length; j++) {
                            var tmp = new AssetType(data.results[j]);
                            results.push(tmp);
                        }
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = AssetType_API_URL;

            // slugSearch = "&";

            if (($("#nameAssetTypeFilterSearchInputId").length > 0)
                ||($("#AssetOfTypeFilterSearchInputId").length > 0)){
                var value_name = $("#nameAssetTypeFilterSearchInputId").val();
                var value_asset_of_type = $("#AssetOfTypeFilterSearchInputId").val();
                if ((value_name != "" && value_name != null)
                    || (value_asset_of_type != "" && value_asset_of_type != null)) {
                        slugSearch += "&name__icontains=" + value_name
                                + "&asset_of_type=" + value_asset_of_type;
                }
            }

        } else {
            SEARCH_URL = AssetType_Search_URL;

            slugSearch = "&";
            slugSearch += "search=" + $("#AssetTypeQuickSearchInputId").val();
    ...
    tFillTable3(tableId = null, order = null) {
        var tbId = "AssetTypeDataTableId";
        if (tableId != null) {
            tbId = tableId;
        }

        if (order == null) {
            order = ASSETTYPE_ID_TABLE_COUNT;
        }
        var table = $("#" + tbId);
        if (table.length > 0) {
            var html = "<tr>"
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if (attr == "name") {
                        html += `<td class="text-wrap" style="min-width:300px" onclick="AssetTypeDetails('` + this["uuid"] + `')"><a>` + (this[attr]) + `</a></td>`;
                        continue;
                    }
...
// fill table function
function AssetTypeGetDataTable(page = 1, search_data = null) {
    search_log["search_func"] = "AssetTypeGetDataTable";
    ...
    obj.callAjax.then(function (data) {
        $("#AssetTypeTableBodyId").empty();
        var body = $("#AssetTypeDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        ASSETTYPE_ID_TABLE_COUNT = 1;
        var crr_record_in_page = AccountAccountrecord_in_page;

        if (page > 1) {
            ASSETTYPE_ID_TABLE_COUNT = 1 + crr_record_in_page * page - crr_record_in_page
        }
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetTypeGetDataTable(1)">Đầu</a></li>`);
            if (pagination["has_prev"] == true) {
                pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="AssetTypeGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
            }
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetTypeGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "AssetTypeDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "AssetTypeDetailModalsFormId";
    AssetTypeViewDetail(selectionId)
})

// [Save Create] Clicked Handle function
$(document).ready(function () {
    $("#AssetTypeCreateModalBtnId").click(function () {
        var validate_obj = new InputValidation('AssetTypeCreateModalsFormId');
        ...
        obj.tCreateNewPostFormApi('AssetTypeCreateModalsFormId');
    })
});

// [SAVE UPDATE]
$(document).ready(function () {
    $("#AssetTypeUpdateModalBtnId").click(function () {
        obj = new AssetType();
        obj.tUpdatePostApi('AssetTypeEditModalsFormId');
    })
});

// add selected
$(document).ready(function () {
    SelectedFieldModal(AssetOfType_API_URL, "Edit", "asset_of_type")

    //Add
    SelectedFieldModal(AssetOfType_API_URL, "Create", "asset_of_type")
});
    ...
    for (var i = 1; i < 2; i++) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#" + InputId + "AssetType" + apart + "ModalInputId").append(html);
            }
        });
    }
}
...
// Export excel
$(document).ready(function () {
    $('#AssetTypeExportExcelBtnId').click(function () {
        // Define the columns to export
        var columnsToExport = [0, 1, 2, 3]; // columns 1, 2, and 4 (zero-indexed)
        var theadToExport = '';
        $('#AssetTypeDataTableId thead').each(function () {
            var row = '';
        ...
        var tbodyToExport = '';
        $('#AssetTypeDataTableId tbody tr').each(function () {
            var row = '';
        ...
        $(tempTable).tableExport({
            filename: 'thông_tin_loại_tài_sản_%DD%-%MM%-%YY%',
            format: 'xls',
            escape: 'false',
...
// Run Select Filter
$(document).ready(function () {
    AppendSelectFilter(AssetOfType_API_URL, "AssetOfTypeFilterSearchInputId")
});

// Search Start - khoi tao doi tuong function
function AssetTypeSearchData(page = 1, search_type, search_data = null) {
    search_log["search_func"] = "AssetTypeSearchData";
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetTypeSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);

            if (pagination["has_prev"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetTypeSearchData(` + (parseInt(pagination["current_page"]) - 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
            }
            pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
            if (pagination["has_next"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetTypeSearchData(` + (parseInt(pagination["current_page"]) + 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetTypeSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
        if (search_type == "quick") {
            var crr_txt = $("#AssetTypeQuickSearchInputId").val();
            highlight(crr_txt, "#AssetTypeTableBodyId");
        }
        if (search_type == "filter") {
            var crr_txt = $("#nameAssetTypeFilterSearchInputId").val();
            highlight(crr_txt, "#AssetTypeTableBodyId");
        }
    })
...
$(document).ready(function () {
    $("#AssetTypeQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            AssetTypeSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    $("#AssetTypeQuickSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
    ...
    $("#AssetTypeFilterSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
        ...
        AssetTypeSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search
