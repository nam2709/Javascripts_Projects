...
class UnitUnit {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            this.__model_name__ = "UnitCategory";
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameUnitUnitInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buyUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#owned_companyUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_byUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_byUnitUnitInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#price_buyUnitUnitInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedUnitUnitInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeUnitUnitInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseUnitUnitInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierUnitUnitInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusUnitUnitInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusUnitUnitInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#owned_companyUnitUnitInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atUnitUnitInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atUnitUnitInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_byUnitUnitInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_byUnitUnitInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_tndid = $("#codeUnitUnitInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeUnitUnitInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        try {
            var j_ele_code = $("#dcodeUnitUnit" + apart + "InputId");
        ...
        try {
            var j_ele_updated_at = $("#updated_atUnitUnit" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atUnitUnit" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_name = $("#created_byUnitUnit" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
    ...
    tUpdatePostApi(formId = null) {
        ...
        console.log(idForm)
        $.ajax({
            url: UnitCategory_API_URL + idForm + "/",
            // type: "PUT",
            type: "PATCH",
            async: false,
            cache: false,
            ...
            success: function (data) {
                ...
                UnitUnitGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
    ...
    tDeleteApi(uuid = null) {
        ...
        $.ajax({
            url: UnitCategory_API_URL + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: UnitCategory_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
...
function UnitUnitGetDataTable(page = 1, search_data = null) {
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="UnitUnitGetDataTable(1)">Đầu</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="UnitUnitGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "UnitUnitDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "UnitUnitDetailModalsFormId";
    UnitUnitViewDetail(selectionId)
})
...
$(document).ready(function () {
    $('#UnitUnitExportExcelBtnId').click(function () {
        ...
        $(tempTable).tableExport({
            filename: 'thông_tin_đơn_vị_tính_%DD%-%MM%-%YY%',
            format: 'xls',
            escape: 'false',
...
function UnitUnitSearchData(page = 1, search_type, search_data = null) {
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="UnitUnitSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="UnitUnitSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
...
$(document).ready(function () {
    $("#UnitUnitQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            UnitUnitSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    ...
    $("#UnitUnitSearchBtnId").click(function () {
        ...
        UnitUnitSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search
