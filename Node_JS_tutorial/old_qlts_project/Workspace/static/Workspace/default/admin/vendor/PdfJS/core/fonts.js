...
var Font = (function FontClosure() {
  ...
  function validateOS2Table(os2, file) {
    ...
    //  verify all OS/2 tables fields, but currently we validate only those
    // that give us issues
  ...
  Font.prototype = {
    ...
    checkAndRepair: function Font_checkAndRepair(name, font, properties) {
      ...
      function readCmapTable(cmap, file, isSymbolicFont, hasEncoding) {
        ...
        // (mack): refactor this cmap subtable reading logic out
        if (format === 0) {
          for (j = 0; j < 256; j++) {
        ...
        if (
          ...
          for (let charCode = 0; charCode < 256; charCode++) {
            ...
            if (cmapPlatformId === 3 && cmapEncodingId === 1) {
              ...
              // : the encoding needs to be updated with mac os table.
    ...
    convert: function Font_convert(fontName, font, properties) {
      // : Check the charstring widths to determine this.
