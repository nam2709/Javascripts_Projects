...
function postFormDataFromTableBotUAWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
...
function getDataToInlineTableBotUAWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
var BOTUA_CACHE = [];
var CURRENT_BotUAWebsite = null;
var CURRENT_BOTUA_UUID = null;
var BOTUA_WEBSITE_ID_TABLE_COUNT = 1;
var BOTUA_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class BotUAWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#activeBotUAWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atBotUAWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atBotUAWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#nameBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#activeBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.active = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atBotUAWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#nameBotUAWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidBotUAWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_active = $("#activeBotUAWebsiteInputId");
            }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atBotUAWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atBotUAWebsiteInputId");
                }
            ...
            success: function (data) {
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/BotUA/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#botuaWebsiteEditFormId');
        ...
        if (targetUrl==null){
            targetUrl = BotUAWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idBotUAWebsiteInputId').val(null);
        $('#uuidBotUAWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#botuaWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = BotUAWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = BotUAWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new BotUAWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new BotUAWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                BOTUA_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( BOTUA_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = BotUAWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = BotUAWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = BotUAWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                BOTUA_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = BotUAWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = BotUAWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new BotUAWebsite(data);
                try{
                ...
                //        var tmp = new BotUAWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "BotUAWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + BOTUA_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + BOTUA_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary botua-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning botua-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger botua-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="botua-website-remove-inline-row">
...
var BotUAWebsiteList_CACHE = [];
// ########## Get List Class ##############
class BotUAWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            ...
            success: function (data) {
                BotUAWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new BotUAWebsite_ListItem(data.results[i]);
                        BotUAWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return BotUAWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#botuaWebsiteDataTableId');
    if (dt.length > 0){
        var botuaWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#botuaWebsiteCreateBtnId").click(function(){
        obj = new BotUAWebsite();
...
$(document).ready( function () {
    $(".botua-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new BotUAWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("botuaWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#botuaWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#botuaWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_BOTUA_UUID = null;
        clearForm("botuaWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".botua-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("botuaWebsiteModalDetailFormId");
        $("#" + "botuaWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "botuaWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#botuaWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#botuaWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_BOTUA_UUID = null;
        clearForm("botuaWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".botua-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("botuaWebsiteModalEditFormId");
        $("#" + "botuaWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "botuaWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#botuaWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#botuaWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_BOTUA_UUID = null;
        clearForm("botuaWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#botuaWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#botuaWebsiteUpdateBtnId").click(function(){
        obj = new BotUAWebsite();
...
$(document).ready(function(){
    $("#botuaWebsiteSaveAndNewBtnId").click(function(){
        obj = new BotUAWebsite();
...
$(document).ready(function(){
    $("#botuaWebsiteDeleteBtnId").click(function(){
        obj = new BotUAWebsite();
...
$(document).ready(function(){
    $("#botuaWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTableBotUAWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".botua-website-inline-delete-button").click(function(){
        var obj = new BotUAWebsite();
...
$(document).ready(function(){
    if ($(".botua-website-select.autoload").length > 0){
        var obj = new BotUAWebsiteList();
        BotUAWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < BotUAWebsiteList_CACHE.length; l++){
            crr = BotUAWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".botua-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".botua-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".botua-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".botua-website-select").each(function(event){
...
$(document).ready(function(){
    $(".botua-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".botua-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".botua-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#botuaWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestBotUAWebsite(formId){
    var b_json = genBotUAWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new BotUAWebsite(b_json);
    var d_obj = new BotUAWebsite(b_json);
    ...
    // var d_obj = new BotUAWebsiteList();
...
$(document).ready(function(){
    $("#botuaWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "botuaWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new BotUAWebsite();
            $("#botuaWebsiteTableBodyId").empty();
            var body = $("#botuaWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            BOTUA_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#botuaWebsiteSearchBtnId").click(function(){
        BOTUA_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#botuaWebsiteDataTableId");
        ...
        var keyword = $("#botuaWebsiteSearchInputId").val();
        var obj = new BotUAWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#botuaWebsiteFilterSearchBtnId").click(function(){
        BOTUA_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "botuaWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#botuaWebsiteSearchFilterFormId").serializeArray();
        var obj = new BotUAWebsite();
...
$(document).ready(function(){
    var checker = $("#botuaWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#botuaWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#botuaWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#botuaWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#botuaWebsiteInlineCreateTableId").find('.botua-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#botuaWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#botuaWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#botuaWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#botuaWebsiteInlineDetailTableId").find('.botua-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#botuaWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#botuaWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#botuaWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#botuaWebsiteInlineEditTableId").find('.botua-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#botuaWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#botuaWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".botua-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    BOTUA_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#botuaWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.botua-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#botuaWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("botuaWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("botuaWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var BOTUA_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#botuaWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "botuaWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new BotUAWebsite();
            $("#botuaWebsiteInlineTableBodyId").empty();
            var body = $("#botuaWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
