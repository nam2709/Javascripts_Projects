...
function postFormDataFromTableAdminMenuGroupWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    ...
    $(tableEle).find('tbody>tr').each(function(){
        ...
        try{
            ...
            var tObj = new AdminMenuGroupWebsite();
...
function getDataToInlineTableAdminMenuGroupWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
var genAdminMenuGroupWebsite_FIELDS = [
        "name",
        "uuid",
        "title",
        "icon_class",
...
function genAdminMenuGroupWebsite(){
    return {
    "name": makeid(),
    "uuid": uuidv4(),
    "title": makeid(),
    ...
    "app": genRandomSelect('.app-adminmenugroup-website-option'),
    "related_apps": genRandomSelect('.related_apps-adminmenugroup-website-option'),
    "updated_at": randomDate(),
    "created_at": randomDate(),
    }
}

var ADMINMENUGROUP_CACHE = [];
var CURRENT_AdminMenuGroupWebsite = null;
var CURRENT_ADMINMENUGROUP_UUID = null;
var ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT = 1;
var ADMINMENUGROUP_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class AdminMenuGroupWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#titleAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#icon_classAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#descAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#orderAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#activeAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#is_baseAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#staff_onlyAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#superuser_onlyAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#appAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.app = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#related_appsAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#nameAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#titleAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.title = chEle.val();
            }
            else{
            ...
            var chEle = $("#icon_classAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.icon_class = chEle.val();
            }
            else{
            ...
            var chEle = $("#descAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = $("#orderAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.order = chEle.val();
            }
            else{
            ...
            var chEle = $("#activeAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.active = chEle.val();
            }
            else{
            ...
            var chEle = $("#is_baseAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.is_base = chEle.val();
            }
            else{
            ...
            var chEle = $("#staff_onlyAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.staff_only = chEle.val();
            }
            else{
            ...
            var chEle = $("#superuser_onlyAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.superuser_only = chEle.val();
            }
            else{
            ...
            var chEle = $("#appAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.app = chEle.val();
            }
            else{
            ...
            var chEle = $("#related_appsAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.related_apps = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atAdminMenuGroupWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#nameAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_title = $("#titleAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_icon_class = $("#icon_classAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_desc = $("#descAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_order = $("#orderAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_active = $("#activeAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_is_base = formEle.find("[name='is_base']");
            }
            else{
                var j_ele_is_base = $("#is_baseAdminMenuGroupWebsiteInputId");
            }
            if (j_ele_is_base.length > 0){
                var input_type = j_ele_is_base.attr('type');
                console.log("[tFillForm] ", input_type);
                if (input_type == 'checkbox'){
                    if (self.is_base == true){
                        j_ele_is_base.prop('checked', true);
                    }
                    else {
                        j_ele_is_base.prop('checked', false);
                    }
                }
            }
            else{
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_staff_only = $("#staff_onlyAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_superuser_only = $("#superuser_onlyAdminMenuGroupWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_app = formEle.find("[name='app']");
            }
            else{
                var j_ele_app = $("#appAllAppAdminMenuGroupWebsiteInputId");
            }
            var this_id = j_ele_app.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_app.length > 0){
                var tagName = j_ele_app.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_app.text(self.app).change();

                    // For CKEDITOR update
                    if (j_ele_app.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.app);
                    }
                    break;
        // ######################
                  case "SELECT":
                    ...
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.app)){
                            var tmpArr = self.app.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.app;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.app.hasOwnProperty('uuid')){
                                    $(j_ele_app).val(self.app.uuid).change();
                                }
                                else{
                                    if (self.app.hasOwnProperty('id')){
                                        $(j_ele_app).val(self.app.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_app).val(self.app).change();
                ...
                // j_ele_app.val(null);
                console.log('[tFillForm] Not found element...', app);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_related_apps = formEle.find("[name='related_apps']");
            }
            else{
                var j_ele_related_apps = $("#related_appsAllAppAdminMenuGroupWebsiteInputId");
            }
            var this_id = j_ele_related_apps.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_related_apps.length > 0){
                var tagName = j_ele_related_apps.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_related_apps.text(self.related_apps).change();

                    // For CKEDITOR update
                    if (j_ele_related_apps.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.related_apps);
                    }
                    break;
        // ######################
                  case "SELECT":
                    var tx = j_ele_related_apps;
                    // ManyToMany Field processing
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.related_apps)){
                            var tmpArr = self.related_apps.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.related_apps;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.related_apps.hasOwnProperty('uuid')){
                                    $(j_ele_related_apps).val(self.related_apps.uuid).change();
                                }
                                else{
                                    if (self.related_apps.hasOwnProperty('id')){
                                        $(j_ele_related_apps).val(self.related_apps.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_related_apps).val(self.related_apps).change();
                ...
                console.log('[tFillForm] Not found element...', related_apps);
            }
        }
        catch(err) {
            console.log('err = ', err);
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atAdminMenuGroupWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atAdminMenuGroupWebsiteInputId");
                }
    ...
    tCreatePostApi(targetUrl=null, async_flag=false){
        ...
        var self = this;
        if (targetUrl==null){
            targetUrl = AdminMenuGroupWebsite_URL;
        }
        $.ajax({
            url: targetUrl,
            type: "POST",
            ...
            success: function (data) {
                    self = new AdminMenuGroupWebsite(data);
                    $.confirm({
                        title: 'Info!',
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/AdminMenuGroup/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#adminmenugroupWebsiteEditFormId');
        ...
        var file_eles = $(".adminmenugroup-website");
        for (var i = 0; i < file_eles.length; i++) {
            console.log('file_eles[i] = ', file_eles[i]);
            var files = file_eles[i].files;
            // Check file selected or not
        ...
        if (targetUrl==null){
            targetUrl = AdminMenuGroupWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idAdminMenuGroupWebsiteInputId').val(null);
        $('#uuidAdminMenuGroupWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#adminmenugroupWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = AdminMenuGroupWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = AdminMenuGroupWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new AdminMenuGroupWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new AdminMenuGroupWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = AdminMenuGroupWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = AdminMenuGroupWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = AdminMenuGroupWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                ADMINMENUGROUP_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = AdminMenuGroupWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = AdminMenuGroupWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new AdminMenuGroupWebsite(data);
                try{
                ...
                //        var tmp = new AdminMenuGroupWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "AdminMenuGroupWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + ADMINMENUGROUP_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary adminmenugroup-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning adminmenugroup-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger adminmenugroup-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="adminmenugroup-website-remove-inline-row">
    ...
    tFillList1(listId=null){
        if (listId==null){
            var lsId = "AdminMenuGroupWebsiteListId";
            var lst = $("#" + lsId);
        }
        else{
            var lst = $("#" + listId);
...
class AdminMenuGroupWebsite_ListItem {
    constructor(data){
        if (data != null){
            this.id = data.id;
            this.uuid = data.uuid;
...
var AdminMenuGroupWebsiteList_CACHE = [];
// ########## Get List Class ##############
class AdminMenuGroupWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            url: AdminMenuGroupWebsite_LIST_URL,
            type: "GET",
            async: async_flag,
            cache: false,
            timeout: 30000,
            ...
            success: function (data) {
                AdminMenuGroupWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new AdminMenuGroupWebsite_ListItem(data.results[i]);
                        AdminMenuGroupWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return AdminMenuGroupWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#adminmenugroupWebsiteDataTableId');
    if (dt.length > 0){
        var adminmenugroupWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteCreateBtnId").click(function(){
        obj = new AdminMenuGroupWebsite();
...
$(document).ready( function () {
    $(".adminmenugroup-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new AdminMenuGroupWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("adminmenugroupWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#adminmenugroupWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#adminmenugroupWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_ADMINMENUGROUP_UUID = null;
        clearForm("adminmenugroupWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".adminmenugroup-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("adminmenugroupWebsiteModalDetailFormId");
        $("#" + "adminmenugroupWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "adminmenugroupWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#adminmenugroupWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#adminmenugroupWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_ADMINMENUGROUP_UUID = null;
        clearForm("adminmenugroupWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".adminmenugroup-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("adminmenugroupWebsiteModalEditFormId");
        $("#" + "adminmenugroupWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "adminmenugroupWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#adminmenugroupWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#adminmenugroupWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_ADMINMENUGROUP_UUID = null;
        clearForm("adminmenugroupWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#adminmenugroupWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteUpdateBtnId").click(function(){
        obj = new AdminMenuGroupWebsite();
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteSaveAndNewBtnId").click(function(){
        obj = new AdminMenuGroupWebsite();
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteDeleteBtnId").click(function(){
        obj = new AdminMenuGroupWebsite();
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTableAdminMenuGroupWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".adminmenugroup-website-inline-delete-button").click(function(){
        var obj = new AdminMenuGroupWebsite();
...
$(document).ready(function(){
    if ($(".adminmenugroup-website-select.autoload").length > 0){
        var obj = new AdminMenuGroupWebsiteList();
        AdminMenuGroupWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < AdminMenuGroupWebsiteList_CACHE.length; l++){
            crr = AdminMenuGroupWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".adminmenugroup-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".adminmenugroup-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".adminmenugroup-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".adminmenugroup-website-select").each(function(event){
...
$(document).ready(function(){
    $(".adminmenugroup-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".adminmenugroup-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".adminmenugroup-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#adminmenugroupWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestAdminMenuGroupWebsite(formId){
    var b_json = genAdminMenuGroupWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new AdminMenuGroupWebsite(b_json);
    var d_obj = new AdminMenuGroupWebsite(b_json);
    ...
    // var d_obj = new AdminMenuGroupWebsiteList();
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "adminmenugroupWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new AdminMenuGroupWebsite();
            $("#adminmenugroupWebsiteTableBodyId").empty();
            var body = $("#adminmenugroupWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteSearchBtnId").click(function(){
        ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#adminmenugroupWebsiteDataTableId");
        ...
        var keyword = $("#adminmenugroupWebsiteSearchInputId").val();
        var obj = new AdminMenuGroupWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#adminmenugroupWebsiteFilterSearchBtnId").click(function(){
        ADMINMENUGROUP_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "adminmenugroupWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#adminmenugroupWebsiteSearchFilterFormId").serializeArray();
        var obj = new AdminMenuGroupWebsite();
...
$(document).ready(function(){
    var checker = $("#adminmenugroupWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#adminmenugroupWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#adminmenugroupWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#adminmenugroupWebsiteInlineCreateTableId").find('.adminmenugroup-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#adminmenugroupWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#adminmenugroupWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#adminmenugroupWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#adminmenugroupWebsiteInlineDetailTableId").find('.adminmenugroup-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#adminmenugroupWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#adminmenugroupWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#adminmenugroupWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#adminmenugroupWebsiteInlineEditTableId").find('.adminmenugroup-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#adminmenugroupWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#adminmenugroupWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".adminmenugroup-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    ADMINMENUGROUP_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#adminmenugroupWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.adminmenugroup-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#adminmenugroupWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("adminmenugroupWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("adminmenugroupWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var ADMINMENUGROUP_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#adminmenugroupWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "adminmenugroupWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new AdminMenuGroupWebsite();
            $("#adminmenugroupWebsiteInlineTableBodyId").empty();
            var body = $("#adminmenugroupWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
