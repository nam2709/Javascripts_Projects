...
function BotUAWorkspacegenRandomSelect(optionId){
    try{
...
function genBotUAWorkspace(form_type){
    return {
        "name": makeid(),
        "uuid": uuidv4(),
        "active": genBoolean(),
...
var BotUAWorkspace_CACHE = [];

           var BotUAWorkspace_arr_action = [
        // default action
        
                    {
                    "title": "Xem chi tiết",
                    "func": "BotUAWorkspaceDetails",
                    "icon": "far fa-eye",
                    "href": "#",
                    "isCheck": false,
                    ...
                    {
                        "title": "Xóa",
                        "func": "BotUAWorkspaceOnDeleteEvent",
    ...
    // default func actions
                    ...
                    function BotUAWorkspaceDetails(uuid){
                        $('#botuaWorkspaceDetailmodalsId').modal('toggle');
                        var obj=new BotUAWorkspace();
                        obj.tGetObjApi(uuid);
                        obj.callAjax.then(function(data) {
                            new BotUAWorkspace(data).tFillFormModal('Detail','botuaWorkspaceDetailModalsFormId');
                    ...
                    function BotUAWorkspaceEdit(uuid){
                        $('#botuaWorkspaceEditmodalsId').modal('toggle');
                        var obj=new BotUAWorkspace();
                        obj.tGetObjApi(uuid);
                        obj.callAjax.then(function(data) {
                            new BotUAWorkspace(data).tFillFormModal('Edit','botuaWorkspaceEditModalsFormId');

                        })
                        //obj.tFillFormModal('Edit');
                    }
                    
                    function BotUAWorkspaceOnDeleteEvent(uuid){
                        var search_data = null;
                        try {
                            search_data = BotUAActionsSearchData;
                        }
                        catch(err) {
                            search_data = null;
                        }
                        if(search_data == null){
                            ...
                            BotUAWorkspaceOnDeleteWithDataSearchEvent(uuid);
                        }

                    }
                    function BotUAWorkspaceOnDeleteWithDataSearchEvent(uuid){
                        $.confirm({
                        icon: 'fa fa-smile-o',
                        title: 'XÓA!',
                        content: 'Bạn có chắc muốn xóa ?!',
                        ...
                        buttons: {
                            ...
                            confirm: {
                                ...
                                action: function() {
                                    ...
                                    obj.tDeleteApiWithDataSearch(uuid,BotUAActionsSearchData);
                                }
                            },
                    ...
                    function BotUAWorkspaceViewDetail(selectionId){
    ...
    // custom func actions
                    ...
                    function activebotuaWorkspaceEventChangeSwitcher($this){
                            var status="";
                            var name = "active";
                            if ($($this).is(":checked")) {
                                status = name;
...
class BotUAWorkspace{
    ...
    constructor(data=null){
        if (data != null){
            ...
            if (data.hasOwnProperty('uuid')){
                this.uuid = data.uuid;
                this.editUrl = '/Workspace/BotUA/edit/' + this.uuid + '/';
                this.detailUrl = '/Workspace/BotUA/detail/' + this.uuid + '/';
            }
            else{
                // this.uuid = null;
            }
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameBotUAWorkspaceInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidBotUAWorkspaceInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#activeBotUAWorkspaceInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atBotUAWorkspaceInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atBotUAWorkspaceInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idBotUAWorkspaceInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
                // this.id = null;
                                ...
                                var chEle = $("#nameBotUAWorkspaceInputId");
                                if (chEle.length > 0){
                                    this.name = chEle.val();
                                }
                                else{
                                ...
                                var chEle = $("#uuidBotUAWorkspaceInputId");
                                if (chEle.length > 0){
                                    this.uuid = chEle.val();
                                }
                                else{
                                ...
                                var chEle = $("#activeBotUAWorkspaceInputId");
                                if (chEle.length > 0){
                                    this.active = chEle.val();
                                }
                                else{
                                ...
                                var chEle = $("#updated_atBotUAWorkspaceInputId");
                                if (chEle.length > 0){
                                ...
                                var chEle = $("#created_atBotUAWorkspaceInputId");
                                if (chEle.length > 0){
                                    var date = moment(chEle.val(), 'DD/MM/YYYY');
    ...
    tFillForm(){
        var self = this;
            ...
            try{
                var j_ele_name = $("#nameBotUAWorkspaceInputId");
            ...
            try{
                var j_ele_uuid = $("#uuidBotUAWorkspaceInputId");
            ...
            try{
                var j_ele_active = $("#activeBotUAWorkspaceInputId");
            ...
            try{
                var j_ele_updated_at = $("#updated_atBotUAWorkspaceInputId");
            ...
            try{
                var j_ele_created_at = $("#created_atBotUAWorkspaceInputId");
    ...
    tFillFormModal(modals_type,formId=null){
        ...
        var self = this;
            ...
            try{
                var j_ele_name = $("#nameBotUAWorkspace"+apart+"InputId");
                if (j_ele_name.length > 0){
                    if (j_ele_name.attr('name') != 'uuid'){
                        j_ele_name.val(self.name).change();
                    }
            ...
            try{
                var j_ele_uuid = $("#uuidBotUAWorkspace"+apart+"InputId");
                ...
                console.log('err = ', err);
                        ...
                        try{
                            var j_ele_active = $("#activeBotUAWorkspace"+apart+"InputId");
                            if (j_ele_active.length > 0){
                                if (j_ele_active.attr('name') != 'uuid'){
            ...
            try{
                var j_ele_updated_at = $("#updated_atBotUAWorkspace"+apart+"InputId");
                if (j_ele_updated_at.length > 0){
                    var dateObj = new Date(Date.parse(self.updated_at)); 
                      if (dateObj != "Invalid Date"){
                        var newdate = moment(dateObj).format('DD/MM/YYYY');
            ...
            try{
                var j_ele_created_at = $("#created_atBotUAWorkspace"+apart+"InputId");
                if (j_ele_created_at.length > 0){
                    var dateObj = new Date(Date.parse(self.created_at)); 
                      if (dateObj != "Invalid Date"){
                        var newdate = moment(dateObj).format('DD/MM/YYYY');
    ...
    tCreatePostApi(){
        ...
        $.ajax({
            ...
            success: function (data) {
                    self = new BotUAWorkspace(data);
                    BotUAWorkspaceGetDataTable(BotUAWorkspacepagination["current_page"]);
                    if(is_continue_form){
                        is_continue_form=false;
                        toastr.success('Thêm mới thành công');
                        $(location).prop('href', "/Workspace/BotUA/create/");
                        

                    }else if(is_continue_modal){
                        is_continue_modal=false;
                        BotUARefreshCreateModal();
                        toastr.success('Thêm mới thành công');
                    }else{
                        $('.modal').modal('hide');
                    //    $.confirm({
                    ...
                    //            text: 'Chi tiết',
                    //            action: function(){
                    //                $(location).prop('href', "/Workspace/BotUA/detail/" + self.uuid + "/");
                    //            }
                     //       },
                    //        close: {
                    //            text: 'Hủy',
    ...
    tUpdatePostApi(formId=null){
        ...
        var arr_table = [];
        if(formId==null){
         formData = new FormData($('#botuaWorkspaceCreateFormId')[0]);
        ...
        if(!is_save_self_table){
            $.ajax({
                url: BotUAWorkspace_URL + self.uuid + "/",
                // type: "PUT",
                type: "PATCH",
                async: false,
                cache: false,
    ...
    tCreateNewPostFormApi(formId=null){
        ...
        $('#idBotUAWorkspaceInputId').val(null);
        $('#uuidBotUAWorkspaceInputId').val(uuidv4());
        var self = this;
        var formData;
        var arr_table = [];
        if(formId==null){
    ...
    tDeleteApi(uuid=null){
        ...
        $.ajax({
            url: BotUAWorkspace_URL + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tDeleteApiWithDataSearch(uuid=null,data_search=null){
        ...
        $.ajax({
            ...
            success: function (data) {
                toastr.success('Xóa thành công');
                BotUAWorkspaceSearchData(BotUAWorkspacepagination["current_page"],"filter",data_search);
                if(cr_uuid!=""){
                    $(location).prop('href', "/Workspace/BotUA/create/");
                }
                console.log(data);
    ...
    tDeleteFileApi(uuid = null,attr_name) {
        ...
        $.ajax({
            url: BotUAWorkspace_REMOVEFILE_URL+uuid+"/",
            type: "PATCH",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page=null,search_data=null){
        ...
        this.callAjax =
        $.ajax({
            url: BotUAWorkspace_URL+has_go_page,
            type: "GET",
            //async: false,
            cache: false,
            timeout: 30000,
            ...
            success: function (data) {
                ...
                // return new BotUAWorkspace(data);
                if (data.hasOwnProperty('count')){
                    BotUAWorkspacepagination["total"]=data.count;
                }
                if (data.hasOwnProperty('count')){
                    BotUAWorkspacepagination["total"]=data.count;
                }
                if (data.hasOwnProperty('next')){
                    if(data.next != null){
                    BotUAWorkspacepagination["has_next"]=true;
                    }else{
                    BotUAWorkspacepagination["has_next"]=false;

                    }
                }
                BotUAWorkspacepagination["current_page"]=page;
                if (data.hasOwnProperty('previous')){
                    if(data.previous != null){
                    BotUAWorkspacepagination["has_prev"]=true;
                    }else{
                    BotUAWorkspacepagination["has_prev"]=false;
                    }
                }
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new BotUAWorkspace(data.results[j]);
                        results.push(tmp);
                    }
    ...
    tGetAllObjLargeApi(page=null,search_data=null){
        ...
        this.callAjax =
        $.ajax({
            url: BotUAWorkspace_LARGE_URL+has_go_page,
            type: "GET",
            //async: false,
            cache: false,
            timeout: 30000,
    ...
    tSearchAllObjApi(page=null,search_data=null,typeSearch){
        ...
        if(typeSearch=="filter"){
            SEARCH_URL=BotUAWorkspace_FILTER_URL;
            
                slugSearch="&";
            
                                if($("#nameBotUAWorkspaceFilterSearchInputId").length>0){
                                    var value=$("#nameBotUAWorkspaceFilterSearchInputId").val();
                                    if(value!="" && value!=null){
            ...
            SEARCH_URL=BotUAWorkspace_SEARCH_URL;
            
                slugSearch="&";
                slugSearch+="search="+$("#botuaWorkspaceQuickSearchInputId").val();
    ...
    tSearchLargeObjApi(page=null,search_data=null,typeSearch){
        ...
        var SEARCH_URL="";
        if(typeSearch=="filter"){
            SEARCH_URL=BotUAWorkspace_LARGE_FILTER_URL;
    ...
    tGetObjApi(uuid){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new BotUAWorkspace(data);
                console.log('n_obj = ', n_obj);
                n_obj.tFillForm();
                return n_obj;
                // if (data.hasOwnProperty('results')){
                //    if (data.results.length > 0){
                //        var tmp = new BotUAWorkspace(data[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(){
        var tbId = "botuaWorkspaceDataTableId";
        var table = $("#" + tbId);
        if (table.length > 0){
    ...
    tFillTable2(){
        ...
        if (table.length > 0){
            ...
            var rowData = [
                `<a href="` + this.detailUrl + `">` + BOTUA_ID_TABLE_COUNT + `</a>`,
        ...
        if (table.length > 0){
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++){
                ...
                if (this.hasOwnProperty(attr)){
                        ...
                        if(attr=="active"){
                            ...
                            html +=`<td class="text-center">
                                    <div class="custom-control custom-switch">
                                        <input class="custom-control-input" id="${this["uuid"]}activebotuaWorkspaceSwitchListTablebtnId" name="`+ attr +`" data-uuid="` + this["uuid"] + `" type="checkbox"  `+value+` onclick="activebotuaWorkspaceEventChangeSwitcher(this)">
                                    <label class="custom-control-label" for="${this["uuid"]}activebotuaWorkspaceSwitchListTablebtnId"></label>
                                    </div></td>`;
                                continue;
                            }
                    ...
                    if(attr=="name"){
                        html +=`<td class="text-wrap" style="min-width:300px" onclick="BotUAWorkspaceDetails('`+this["uuid"]+`')"><a>` + (this[attr]) + `</a></td>`;
                            continue;
                    }
                    ...
                    if(attr=="botua-admin-action")
                    {
                        html +=BindActionButtonVer4(
                            BotUAWorkspace_arr_action,
                            this['uuid'],
                            this,
                            null,
                            this['created_by'],
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++){
                ...
                if (this.hasOwnProperty(attr)){
                    ...
                    if(attr=="botua-admin-action")
                    {
                        ...
                        <a  onclick="BotUA`+action+`DeteleRowAddingTable(this)"> &nbsp;
                            <i title="Xóa" class="fas fa-trash" onclick="BotUA`+action+`DeteleRowAddingTable(this)"></i>&nbsp;
                                            Xóa 
                        </a></td>
                        `;
    ...
    tFillCard(cardId=null,order=null){
        var card_Id = "botuaWorkspaceCardAreaId";
        if(cardId!=null){
            card_Id = cardId;
        }
        ...
        if (card_area.length > 0){
            var card_template = card_area.find(".botuaWorkspaceTemplateCardClass");
            if(card_template.length > 0){
                ...
                for (var thId = 0; thId < cardContent.length; thId++){
                    ...
                    if (this.hasOwnProperty(attr)){
                        ...
                        if(attr=="name"){
                            $(hEle).html(`<a onclick="BotUAWorkspaceDetails('`+this["uuid"]+`')">` + (this[attr]) + `</a>`);
                            continue;
                        }
...
var BotUAWorkspaceList_CACHE = [];
// ########## Get List Class ##############
class BotUAWorkspaceList {
    // ########## Init Objects ##############
    getListApi(){
        $.ajaxSetup({
            headers : {
        ...
        $.ajax({
            ...
            success: function (data) {
                BotUAWorkspaceList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new BotUAWorkspace_ListItem(data.results[i]);
                        BotUAWorkspaceList_CACHE.push(x);
                    }
                }else{
                    for (var i = 0; i < data.length; i++){
                        var x = new BotUAWorkspace_ListItem(data[i]);
                        BotUAWorkspaceList_CACHE.push(x);
                    }
                }
            },
        ...
        return BotUAWorkspaceList_CACHE;
    }
...
$(document).ready( function () {
   const botuaWorkspacedatatablesSimple = document.getElementById('botuaWorkspaceDataTableId');
    if (botuaWorkspacedatatablesSimple) {
        new simpleDatatables.DataTable(botuaWorkspacedatatablesSimple);
    }
...
// ########## tTest function ##############
function tTestBotUAWorkspace(type_action=null){
    var b_json = genBotUAWorkspace();
    console.log("b_json = ", b_json);
    // var d_obj = new BotUAWorkspace(b_json);
    var d_obj = new BotUAWorkspace(b_json);
    ...
    // var d_obj = new BotUAWorkspaceList();
...
// ########## tTest function ##############
function tTestInModalBotUAWorkspace(type_action){
    var form_type = type_action+"Modal";
    var b_json = genBotUAWorkspace(form_type);
    console.log("b_json = ", b_json);
    // var d_obj = new BotUAWorkspace(b_json);
    var d_obj = new BotUAWorkspace(b_json);
    // console.log('d_obj.tCreatePostApi()...', d_obj.tCreatePostApi());
...
$(document).ready(function(){
    $("#botuaWorkspaceEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#botuaWorkspaceQuickSearchInputId").on('keyup', function(e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            BotUAWorkspacepagination={
                current_page:1,
                total:0,
                has_next:false,
                has_prev:false
            }
            BotUAWorkspaceSearchData(BotUAWorkspacepagination["current_page"],"quick");
        }
    })
    $("#botuaWorkspaceQuickSearchBtnId").click(function(){
        BotUAWorkspacepagination={
            current_page:1,
            total:0,
            has_next:false,
    ...
    $("#botuaWorkspaceSearchBtnId").click(function(){
        BotUAWorkspacepagination={
            current_page:1,
            total:0,
            has_next:false,
        ...
        BotUAWorkspaceSearchData(BotUAWorkspacepagination["current_page"],"filter");
    })
});
...
$(document).ready(function(){
    ...
    $("#botuaWorkspaceExportExcelBtnId").click(function(){
        var is_export = true;
        if(search_log["search_func"] == "BotUAWorkspaceGetDataTable"){
                BotUAWorkspaceGetLargeDataTable(1,search_log["search_data"],is_export,BotUAWorkspaceExportExcel);
        }
        else if(search_log["search_func"] == "BotUAWorkspaceSearchData"){
                BotUAWorkspaceSearchLargeData(1,search_log["search_type"],search_log["search_data"],is_export,BotUAWorkspaceExportExcel);
        } 
        
    })
}); 

function BotUAWorkspaceExportExcel(){

    var table=$('#botuaWorkspaceExportTableId');
    var count_cols = table.find("th").length;
    if(table.find("td").length>0){
        table.tableExport({
                filename: '__botua__%DD%-%MM%-%YY%',
                format: 'xls',
...
$(document).ready(function(){
    $("#botuaWorkspaceCreateBtnId").click(function(){
        obj = new BotUAWorkspace();
...
$(document).ready(function(){
    $("#botuaWorkspaceUpdateBtnId").click(function(){
        obj = new BotUAWorkspace();
        console.log('Update obj = ', obj);
        obj.tUpdatePostApi('botuaWorkspaceEditFormId');
    })
});
...
$(document).ready(function(){
    $("#botuaWorkspaceSaveAndNewBtnId").click(function(){
...
$(document).ready(function(){
    $("#botuaWorkspaceDeleteBtnId").click(function(){
        $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?!',
...
$(document).ready(function(){
    $("#botuaWorkspaceCancelCreateModalBtnId").click(function(){
        $(':input','#botuaWorkspaceCreatemodalsId')
  .not(':button, :submit, :reset, :hidden')
  .val('')
  .removeAttr('checked')
  .removeAttr('selected');
    })
    $("#botuaWorkspaceCancelEditModalBtnId").click(function(){
        $(':input','#botuaWorkspaceEditmodalsId')
  .not(':button, :submit, :reset, :hidden')
  .val('')
  .removeAttr('checked')
  .removeAttr('selected');
    })
    $("#botuaWorkspaceCancelDetailModalBtnId").click(function(){
        $(':input','#botuaWorkspaceDetailmodalsId')
  .not(':button, :submit, :reset, :hidden')
  .val('')
  .removeAttr('checked')
  .removeAttr('selected');
...
function BotUARefreshCreateModal() {
    $('#botuaWorkspaceCreatemodalsId')
...
$('#botuaWorkspaceCreatemodalsId').on('hidden.bs.modal', function (e) {
  $(this).removeData('bs.modal');
    ...
    $(this).find("table").each(function() { 
          var table = new botuaWorkspacecreateTnvTable($(this));
          table.refresh(); 
    })
       
})
$('#botuaWorkspaceEditmodalsId').on('hidden.bs.modal', function (e) {
  $(this).removeData('bs.modal');
    $(this)
        .find("input[type=text],input[type=number],textarea,select")
        .val('').removeClass("is-invalid").removeClass("is-valid")
        ...
        .end();
        $(this).find("table").each(function() { 
          var table = new botuaWorkspaceeditTnvTable($(this));
          table.refresh(); 
    })
})
$('#botuaWorkspaceDetailmodalsId').on('hidden.bs.modal', function (e) {
  $(this).removeData('bs.modal');
    $(this)
        .find("input[type=text],input[type=number],textarea,select")
        .val('').removeClass("is-invalid").removeClass("is-valid")
        ...
        .end();
      $(this).find("table").each(function() { 
          var table = new botuaWorkspacedetailTnvTable($(this));
          table.refresh(); 
        })
})
});
...
$(document).ready(function(){
    $("#botuaWorkspaceCreateModalBtnId").click(function(){
        var validate_obj = new InputValidation('botuaWorkspaceCreateModalsFormId');
        ...
        obj = new BotUAWorkspace();
        console.log('Save obj = ', obj);
        obj.tCreateNewPostFormApi('botuaWorkspaceCreateModalsFormId');
    })
});
...
$(document).ready(function(){
    $("#botuaWorkspaceUpdateModalBtnId").click(function(){
        var validate_obj = new InputValidation('botuaWorkspaceEditModalsFormId');
        if(validate_obj.validateRequired()){
            toastr.warning('Vui lòng điền đầy đủ thông tin');
            return;
        ...
        obj = new BotUAWorkspace();
        console.log('Update obj = ', obj);
        obj.tUpdatePostApi('botuaWorkspaceEditModalsFormId');
    })
});
...
$(document).ready(function(){
    $("#botuaWorkspaceSaveAndNewModalBtnId").click(function(){
        obj = new BotUAWorkspace();
        console.log('Save obj and create new, obj = ', obj);
...
function LoadBotUAWorkspaceList(){

if ($(".botua-workspace-select").length > 0){
        var obj = new BotUAWorkspaceList();
        BotUAWorkspaceList_CACHE = obj.getListApi();
        var crr = null;
        for (l = 0; l < BotUAWorkspaceList_CACHE.length; l++){
            crr = BotUAWorkspaceList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.id));
            $(".botua-workspace-select").append(new Option(crr.name, crr.uuid));
        }
    }
}
$(document).ready(function(){
...
$(document).ready(function(){
    var IdTable ="botuaWorkspaceTableBodyId";
    var checker = $("#" +IdTable );
    if (checker.length > 0){
...
function BotUAWorkspaceGetDataTable(page=1,search_data=null){
        search_log["search_func"] = "BotUAWorkspaceGetDataTable";
        ...
        obj.callAjax.then(function(data) {
        $("#botuaWorkspaceTableBodyId").empty();
        var body = $("#botuaWorkspaceDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        BOTUA_ID_TABLE_COUNT = 1;
        if(page>1){
        BOTUA_ID_TABLE_COUNT =1+record_in_page*page-record_in_page
        }
        ...
        var pagenation_ele=$(".pagination-BotUAWorkspace");
        var pagination=BotUAWorkspacepagination;
        pagenation_ele.html('');
        var page_total_ele = $(".page-total-BotUAWorkspace");
        page_total_ele.html(`<footer class="blockquote-footer">Tổng số: ${pagination["total"]} bản ghi </footer>`);
        if (results.length > 0) {
            
                    pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceGetDataTable(1)">Đầu</a></li>`);
                    if (pagination["has_prev"] == true) {
                        pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
                    }
                    ...
                    pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceGetDataTable(`+last_page_order+`)">Cuối</a></li>`);
                    }
                }
    })
}
...
$(document).ready(function(){
    var checker = $("#botuaWorkspaceFormId");
    if (checker.length > 0){
    ...
    checker = $("#botuaWorkspaceDetailFormId");
    if (checker.length > 0){
         cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
            console.log('cr_uuid = ', cr_uuid);
    ...
    checker = $("#botuaWorkspaceEditFormId");
    if (checker.length > 0){
         cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
            console.log('cr_uuid = ', cr_uuid);
...
$(document).ready(function(){
    $("#botuaWorkspaceTestBtnId").click(function(){
        tTestBotUAWorkspace();
    })
     $("#botuaWorkspaceTestEditBtnId").click(function(){
        tTestBotUAWorkspace('Edit');
    })
    $("#botuaWorkspaceTestCreateModalBtnId").click(function(){
        tTestInModalBotUAWorkspace('Create');

    })
     $("#botuaWorkspaceTestEditModalBtnId").click(function(){
        tTestInModalBotUAWorkspace('Edit');
    })
});
    ...
    function BotUAWorkspaceSearchData(page=1,search_type,search_data=null){
        search_log["search_func"] = "BotUAWorkspaceSearchData";
        ...
        search_log["search_data"] = search_data;
            ...
            if (results.length > 0) {
                    pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceSearchData(1,'`+search_type+`'`+ `,'`+search_data+`'`+ `)">Đầu</a></li>`);

                    if (pagination["has_prev"] == true) {
                        pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceSearchData(` + (parseInt(pagination["current_page"]) - 1) +`,'`+search_type+`'`+ `,'`+search_data+`'`+ `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
                    }
                    pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
                    if (pagination["has_next"] == true) {
                        pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceSearchData(` + (parseInt(pagination["current_page"]) + 1) +`,'`+search_type+`'`+ `,'`+search_data+`'`+ `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
                    ...
                    pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="BotUAWorkspaceSearchData(`+last_page_order+`,'`+search_type+`'`+ `,'`+search_data+`'`+ `)">Cuối</a></li>`);
                    }
                }
                if (search_type == "quick") {
                    var crr_txt = $("#botuaWorkspaceQuickSearchInputId").val();
                    highlight(crr_txt,"#botuaWorkspaceTableBodyId");
                }
        })
    ...
    // ########## [Fill Table bySearch] Handle Event function ##############
    function BotUAWorkspaceSearchLargeData(page=1,search_type,search_data=null,is_export,ExportFunc){
            var obj = new BotUAWorkspace();
            var tbId = "botuaWorkspaceExportTableId"
            var results = obj.tSearchLargeObjApi(page,search_data,search_type);
            obj.callAjax.then(function(data) {
            $("#"+tbId).find("table").empty();
            botuaWorkspace_ID_TABLE_COUNT = 1;
            for (var i = 0; i < results.length; i++){
                try{
                    console.log('results[i] = ', results[i]);
    ...
    // ########## [Fill Table bySearch] Handle Event function ##############
    function BotUAWorkspaceGetLargeDataTable(page=1,search_data=null,is_export,ExportFunc){
            var obj = new BotUAWorkspace();
            var tbId = "botuaWorkspaceExportTableId"
    ...
    // ########## [Fill Table bySearch] Handle Event function ##############
    var BOTUA_ID_INLINE_TABLE_COUNT;
    function BotUAWorkspaceFillTableInForm(page=1,search_data=null,tableId=null,action="detail"){
            var obj = new BotUAWorkspace();
            var results = obj.tSearchLargeObjApi(page,search_data,"filter",tableId);
            obj.callAjax.then(function(data) {
                BOTUA_ID_INLINE_TABLE_COUNT = 1;
                if(page>1){
                BOTUA_ID_INLINE_TABLE_COUNT =1+10*page -10;
                }
                if(action=="detail"){
                    ...
                    try{
                        console.log('results[i] = ', results[i]);
                        results[i].tFillTable4(tableId,BOTUA_ID_INLINE_TABLE_COUNT,action);
                        BOTUA_ID_INLINE_TABLE_COUNT++;
                    }
                    catch(err){
                        console.log(err);
                    }
                    ...
                    var table = new botuaWorkspaceeditTnvTable($("#"+tableId)[0]);
