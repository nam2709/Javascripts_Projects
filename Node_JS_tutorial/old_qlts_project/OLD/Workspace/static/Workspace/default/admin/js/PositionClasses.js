...
function postFormDataFromTablePositionWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
...
function getDataToInlineTablePositionWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
var POSITION_CACHE = [];
var CURRENT_PositionWebsite = null;
var CURRENT_POSITION_UUID = null;
var POSITION_WEBSITE_ID_TABLE_COUNT = 1;
var POSITION_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class PositionWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#namePositionWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidPositionWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#descPositionWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#cssPositionWebsiteInputId");
            if (chEle.length > 0){
                this.css = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#orderPositionWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#activePositionWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atPositionWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atPositionWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idPositionWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#namePositionWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidPositionWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#descPositionWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = $("#cssPositionWebsiteInputId");
            if (chEle.length > 0){
                this.css = chEle.val();
            }
            else{
            ...
            var chEle = $("#orderPositionWebsiteInputId");
            if (chEle.length > 0){
                this.order = chEle.val();
            }
            else{
            ...
            var chEle = $("#activePositionWebsiteInputId");
            if (chEle.length > 0){
                this.active = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atPositionWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atPositionWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#namePositionWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidPositionWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_desc = $("#descPositionWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_css = formEle.find("[name='css']");
            }
            else{
                var j_ele_css = $("#cssPositionWebsiteInputId");
            }
            var this_id = j_ele_css.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_css.length > 0){
                var tagName = j_ele_css.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_css.text(self.css).change();

                    // For CKEDITOR update
                    if (j_ele_css.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.css);
                    }
                    break;
        // ######################
                  case "SELECT":
                    ...
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.css)){
                            var tmpArr = self.css.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.css;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.css.hasOwnProperty('uuid')){
                                    $(j_ele_css).val(self.css.uuid).change();
                                }
                                else{
                                    if (self.css.hasOwnProperty('id')){
                                        $(j_ele_css).val(self.css.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_css).val(self.css).change();
                ...
                // j_ele_css.val(null);
                console.log('[tFillForm] Not found element...', css);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_order = $("#orderPositionWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_active = $("#activePositionWebsiteInputId");
            }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atPositionWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atPositionWebsiteInputId");
                }
            ...
            success: function (data) {
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/Position/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#positionWebsiteEditFormId');
        ...
        var file_eles = $(".position-website");
        for (var i = 0; i < file_eles.length; i++) {
            console.log('file_eles[i] = ', file_eles[i]);
            var files = file_eles[i].files;
            // Check file selected or not
        ...
        if (targetUrl==null){
            targetUrl = PositionWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idPositionWebsiteInputId').val(null);
        $('#uuidPositionWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#positionWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = PositionWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = PositionWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new PositionWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new PositionWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                POSITION_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( POSITION_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = PositionWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = PositionWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = PositionWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                POSITION_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = PositionWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = PositionWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new PositionWebsite(data);
                try{
                ...
                //        var tmp = new PositionWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "PositionWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + POSITION_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + POSITION_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary position-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning position-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger position-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="position-website-remove-inline-row">
    ...
    tFillList1(listId=null){
        if (listId==null){
            var lsId = "PositionWebsiteListId";
            var lst = $("#" + lsId);
        }
        else{
            var lst = $("#" + listId);
...
class PositionWebsite_ListItem {
    constructor(data){
        if (data != null){
            this.id = data.id;
            this.uuid = data.uuid;
...
var PositionWebsiteList_CACHE = [];
// ########## Get List Class ##############
class PositionWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            ...
            success: function (data) {
                PositionWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new PositionWebsite_ListItem(data.results[i]);
                        PositionWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return PositionWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#positionWebsiteDataTableId');
    if (dt.length > 0){
        var positionWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#positionWebsiteCreateBtnId").click(function(){
        obj = new PositionWebsite();
...
$(document).ready( function () {
    $(".position-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new PositionWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("positionWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#positionWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#positionWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_POSITION_UUID = null;
        clearForm("positionWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".position-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("positionWebsiteModalDetailFormId");
        $("#" + "positionWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "positionWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#positionWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#positionWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_POSITION_UUID = null;
        clearForm("positionWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".position-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("positionWebsiteModalEditFormId");
        $("#" + "positionWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "positionWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#positionWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#positionWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_POSITION_UUID = null;
        clearForm("positionWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#positionWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#positionWebsiteUpdateBtnId").click(function(){
        obj = new PositionWebsite();
...
$(document).ready(function(){
    $("#positionWebsiteSaveAndNewBtnId").click(function(){
        obj = new PositionWebsite();
...
$(document).ready(function(){
    $("#positionWebsiteDeleteBtnId").click(function(){
        obj = new PositionWebsite();
...
$(document).ready(function(){
    $("#positionWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTablePositionWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".position-website-inline-delete-button").click(function(){
        var obj = new PositionWebsite();
...
$(document).ready(function(){
    if ($(".position-website-select.autoload").length > 0){
        var obj = new PositionWebsiteList();
        PositionWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < PositionWebsiteList_CACHE.length; l++){
            crr = PositionWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".position-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".position-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".position-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".position-website-select").each(function(event){
...
$(document).ready(function(){
    $(".position-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".position-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".position-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#positionWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestPositionWebsite(formId){
    var b_json = genPositionWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new PositionWebsite(b_json);
    var d_obj = new PositionWebsite(b_json);
    ...
    // var d_obj = new PositionWebsiteList();
...
$(document).ready(function(){
    $("#positionWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "positionWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new PositionWebsite();
            $("#positionWebsiteTableBodyId").empty();
            var body = $("#positionWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            POSITION_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#positionWebsiteSearchBtnId").click(function(){
        POSITION_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#positionWebsiteDataTableId");
        ...
        var keyword = $("#positionWebsiteSearchInputId").val();
        var obj = new PositionWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#positionWebsiteFilterSearchBtnId").click(function(){
        POSITION_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "positionWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#positionWebsiteSearchFilterFormId").serializeArray();
        var obj = new PositionWebsite();
...
$(document).ready(function(){
    var checker = $("#positionWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#positionWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#positionWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#positionWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#positionWebsiteInlineCreateTableId").find('.position-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#positionWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#positionWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#positionWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#positionWebsiteInlineDetailTableId").find('.position-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#positionWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#positionWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#positionWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#positionWebsiteInlineEditTableId").find('.position-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#positionWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#positionWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".position-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    POSITION_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#positionWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.position-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#positionWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("positionWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("positionWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var POSITION_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#positionWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "positionWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new PositionWebsite();
            $("#positionWebsiteInlineTableBodyId").empty();
            var body = $("#positionWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
