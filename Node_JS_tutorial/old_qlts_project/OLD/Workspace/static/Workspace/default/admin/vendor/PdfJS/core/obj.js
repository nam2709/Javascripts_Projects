    ...
    if (isDict(action)) {
      ...
      switch (actionName) {
        case "URI":
          ...
          // : pdf spec mentions urls can be relative to a Base
 ...
 *: implement all the Dict functions and make this more efficient.
 */
 ...
 *: support the 'URL' file system (with caching if !/V), portable
