...
function postFormDataFromTableWidgetWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
...
function getDataToInlineTableWidgetWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
function genWidgetWebsite(){
    ...
    "css_code": makeid(128),
    "js_code": makeid(128),
    "position": genRandomSelect('.position-widget-website-option'),
    "order": makeid(),
    "active": genBoolean(),
...
var WIDGET_CACHE = [];
var CURRENT_WidgetWebsite = null;
var CURRENT_WIDGET_UUID = null;
var WIDGET_WEBSITE_ID_TABLE_COUNT = 1;
var WIDGET_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class WidgetWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#titleWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#urlWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.url = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#descWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#html_codeWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#css_codeWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#js_codeWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#positionWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#orderWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#activeWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atWidgetWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#nameWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#titleWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.title = chEle.val();
            }
            else{
            ...
            var chEle = $("#urlWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.url = chEle.val();
            }
            else{
            ...
            var chEle = $("#descWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = $("#html_codeWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.html_code = chEle.val();
            }
            else{
            ...
            var chEle = $("#css_codeWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.css_code = chEle.val();
            }
            else{
            ...
            var chEle = $("#js_codeWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.js_code = chEle.val();
            }
            else{
            ...
            var chEle = $("#positionWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.position = chEle.val();
            }
            else{
            ...
            var chEle = $("#orderWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.order = chEle.val();
            }
            else{
            ...
            var chEle = $("#activeWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.active = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atWidgetWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#nameWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_title = $("#titleWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_url = $("#urlWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_desc = $("#descWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_html_code = $("#html_codeWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_css_code = $("#css_codeWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_js_code = $("#js_codeWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_position = $("#positionPositionWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_order = $("#orderWidgetWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_active = $("#activeWidgetWebsiteInputId");
            }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atWidgetWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atWidgetWebsiteInputId");
                }
            ...
            success: function (data) {
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/Widget/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#widgetWebsiteEditFormId');
        ...
        if (targetUrl==null){
            targetUrl = WidgetWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idWidgetWebsiteInputId').val(null);
        $('#uuidWidgetWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#widgetWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = WidgetWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = WidgetWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new WidgetWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new WidgetWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                WIDGET_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( WIDGET_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = WidgetWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = WidgetWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = WidgetWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                WIDGET_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = WidgetWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = WidgetWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new WidgetWebsite(data);
                try{
                ...
                //        var tmp = new WidgetWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "WidgetWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + WIDGET_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + WIDGET_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary widget-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning widget-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger widget-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="widget-website-remove-inline-row">
...
var WidgetWebsiteList_CACHE = [];
// ########## Get List Class ##############
class WidgetWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            ...
            success: function (data) {
                WidgetWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new WidgetWebsite_ListItem(data.results[i]);
                        WidgetWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return WidgetWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#widgetWebsiteDataTableId');
    if (dt.length > 0){
        var widgetWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#widgetWebsiteCreateBtnId").click(function(){
        obj = new WidgetWebsite();
...
$(document).ready( function () {
    $(".widget-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new WidgetWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("widgetWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#widgetWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#widgetWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_WIDGET_UUID = null;
        clearForm("widgetWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".widget-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("widgetWebsiteModalDetailFormId");
        $("#" + "widgetWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "widgetWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#widgetWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#widgetWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_WIDGET_UUID = null;
        clearForm("widgetWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".widget-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("widgetWebsiteModalEditFormId");
        $("#" + "widgetWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "widgetWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#widgetWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#widgetWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_WIDGET_UUID = null;
        clearForm("widgetWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#widgetWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#widgetWebsiteUpdateBtnId").click(function(){
        obj = new WidgetWebsite();
...
$(document).ready(function(){
    $("#widgetWebsiteSaveAndNewBtnId").click(function(){
        obj = new WidgetWebsite();
...
$(document).ready(function(){
    $("#widgetWebsiteDeleteBtnId").click(function(){
        obj = new WidgetWebsite();
...
$(document).ready(function(){
    $("#widgetWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTableWidgetWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".widget-website-inline-delete-button").click(function(){
        var obj = new WidgetWebsite();
...
$(document).ready(function(){
    if ($(".widget-website-select.autoload").length > 0){
        var obj = new WidgetWebsiteList();
        WidgetWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < WidgetWebsiteList_CACHE.length; l++){
            crr = WidgetWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".widget-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".widget-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".widget-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".widget-website-select").each(function(event){
...
$(document).ready(function(){
    $(".widget-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".widget-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".widget-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#widgetWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestWidgetWebsite(formId){
    var b_json = genWidgetWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new WidgetWebsite(b_json);
    var d_obj = new WidgetWebsite(b_json);
    ...
    // var d_obj = new WidgetWebsiteList();
...
$(document).ready(function(){
    $("#widgetWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "widgetWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new WidgetWebsite();
            $("#widgetWebsiteTableBodyId").empty();
            var body = $("#widgetWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            WIDGET_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#widgetWebsiteSearchBtnId").click(function(){
        WIDGET_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#widgetWebsiteDataTableId");
        ...
        var keyword = $("#widgetWebsiteSearchInputId").val();
        var obj = new WidgetWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#widgetWebsiteFilterSearchBtnId").click(function(){
        WIDGET_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "widgetWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#widgetWebsiteSearchFilterFormId").serializeArray();
        var obj = new WidgetWebsite();
...
$(document).ready(function(){
    var checker = $("#widgetWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#widgetWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#widgetWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#widgetWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#widgetWebsiteInlineCreateTableId").find('.widget-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#widgetWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#widgetWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#widgetWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#widgetWebsiteInlineDetailTableId").find('.widget-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#widgetWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#widgetWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#widgetWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#widgetWebsiteInlineEditTableId").find('.widget-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#widgetWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#widgetWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".widget-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    WIDGET_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#widgetWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.widget-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#widgetWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("widgetWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("widgetWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var WIDGET_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#widgetWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "widgetWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new WidgetWebsite();
            $("#widgetWebsiteInlineTableBodyId").empty();
            var body = $("#widgetWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
