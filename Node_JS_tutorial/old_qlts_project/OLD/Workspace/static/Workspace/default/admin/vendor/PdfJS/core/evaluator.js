...
class PartialEvaluator {
  ...
  loadFont(fontName, font, resources) {
    ...
    //  move promises into translate font
  ...
  handleColorN(
    ...
    if (patternName instanceof Name) {
      ...
      // : Attempt to lookup cached TilingPatterns by reference as well,
          ...
          case OPS.setGState:
            ...
            next(
              new Promise(function (resolveGState, rejectGState) {
                ...
                // : Attempt to lookup cached GStates by reference as well,
  ...
  extractDataStructures(dict, baseDict, properties) {
    ...
    // : Loading the built in encoding in the font would allow the
  ...
  translateFont(preEvaluatedFont) {
    ...
    //  Fill the width array depending on which of the base font this is
    // a variant.
...
class EvaluatorPreprocessor {
  ...
  constructor(stream, xref, stateManager) {
    // (mduan): pass array of knownCommands rather than this.opMap
    // dictionary
  ...
  read(operation) {
    ...
    while (true) {
      ...
      if (obj instanceof Cmd) {
        ...
        //  figure out how to type-check vararg functions
