...
function postFormDataFromTableRobotsArgWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
...
function getDataToInlineTableRobotsArgWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
var genRobotsArgWebsite_FIELDS = [
        "name",
        "uuid",
        "value",
        "active",
...
var ROBOTSARG_CACHE = [];
var CURRENT_RobotsArgWebsite = null;
var CURRENT_ROBOTSARG_UUID = null;
var ROBOTSARG_WEBSITE_ID_TABLE_COUNT = 1;
var ROBOTSARG_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class RobotsArgWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#valueRobotsArgWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#activeRobotsArgWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atRobotsArgWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atRobotsArgWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#nameRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#valueRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.value = chEle.val();
            }
            else{
            ...
            var chEle = $("#activeRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.active = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atRobotsArgWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#nameRobotsArgWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidRobotsArgWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_value = $("#valueRobotsArgWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_active = $("#activeRobotsArgWebsiteInputId");
            }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atRobotsArgWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atRobotsArgWebsiteInputId");
                }
    ...
    tCreatePostApi(targetUrl=null, async_flag=false){
        ...
        var self = this;
        if (targetUrl==null){
            targetUrl = RobotsArgWebsite_URL;
        }
        $.ajax({
            url: targetUrl,
            type: "POST",
            ...
            success: function (data) {
                    self = new RobotsArgWebsite(data);
                    $.confirm({
                        title: 'Info!',
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/RobotsArg/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#robotsargWebsiteEditFormId');
        ...
        var file_eles = $(".robotsarg-website");
        for (var i = 0; i < file_eles.length; i++) {
            console.log('file_eles[i] = ', file_eles[i]);
            var files = file_eles[i].files;
            // Check file selected or not
        ...
        if (targetUrl==null){
            targetUrl = RobotsArgWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idRobotsArgWebsiteInputId').val(null);
        $('#uuidRobotsArgWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#robotsargWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = RobotsArgWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = RobotsArgWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new RobotsArgWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new RobotsArgWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                ROBOTSARG_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( ROBOTSARG_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = RobotsArgWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = RobotsArgWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = RobotsArgWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                ROBOTSARG_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = RobotsArgWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = RobotsArgWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new RobotsArgWebsite(data);
                try{
                ...
                //        var tmp = new RobotsArgWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "RobotsArgWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + ROBOTSARG_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + ROBOTSARG_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary robotsarg-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning robotsarg-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger robotsarg-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="robotsarg-website-remove-inline-row">
    ...
    tFillList1(listId=null){
        if (listId==null){
            var lsId = "RobotsArgWebsiteListId";
            var lst = $("#" + lsId);
        }
        else{
            var lst = $("#" + listId);
...
class RobotsArgWebsite_ListItem {
    constructor(data){
        if (data != null){
            this.id = data.id;
            this.uuid = data.uuid;
...
var RobotsArgWebsiteList_CACHE = [];
// ########## Get List Class ##############
class RobotsArgWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            ...
            success: function (data) {
                RobotsArgWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new RobotsArgWebsite_ListItem(data.results[i]);
                        RobotsArgWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return RobotsArgWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#robotsargWebsiteDataTableId');
    if (dt.length > 0){
        var robotsargWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#robotsargWebsiteCreateBtnId").click(function(){
        obj = new RobotsArgWebsite();
...
$(document).ready( function () {
    $(".robotsarg-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new RobotsArgWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("robotsargWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#robotsargWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#robotsargWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_ROBOTSARG_UUID = null;
        clearForm("robotsargWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".robotsarg-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("robotsargWebsiteModalDetailFormId");
        $("#" + "robotsargWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "robotsargWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#robotsargWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#robotsargWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_ROBOTSARG_UUID = null;
        clearForm("robotsargWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".robotsarg-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("robotsargWebsiteModalEditFormId");
        $("#" + "robotsargWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "robotsargWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#robotsargWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#robotsargWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_ROBOTSARG_UUID = null;
        clearForm("robotsargWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#robotsargWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#robotsargWebsiteUpdateBtnId").click(function(){
        obj = new RobotsArgWebsite();
...
$(document).ready(function(){
    $("#robotsargWebsiteSaveAndNewBtnId").click(function(){
        obj = new RobotsArgWebsite();
...
$(document).ready(function(){
    $("#robotsargWebsiteDeleteBtnId").click(function(){
        obj = new RobotsArgWebsite();
...
$(document).ready(function(){
    $("#robotsargWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTableRobotsArgWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".robotsarg-website-inline-delete-button").click(function(){
        var obj = new RobotsArgWebsite();
...
$(document).ready(function(){
    if ($(".robotsarg-website-select.autoload").length > 0){
        var obj = new RobotsArgWebsiteList();
        RobotsArgWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < RobotsArgWebsiteList_CACHE.length; l++){
            crr = RobotsArgWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".robotsarg-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".robotsarg-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".robotsarg-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".robotsarg-website-select").each(function(event){
...
$(document).ready(function(){
    $(".robotsarg-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".robotsarg-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".robotsarg-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#robotsargWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestRobotsArgWebsite(formId){
    var b_json = genRobotsArgWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new RobotsArgWebsite(b_json);
    var d_obj = new RobotsArgWebsite(b_json);
    ...
    // var d_obj = new RobotsArgWebsiteList();
...
$(document).ready(function(){
    $("#robotsargWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "robotsargWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new RobotsArgWebsite();
            $("#robotsargWebsiteTableBodyId").empty();
            var body = $("#robotsargWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            ROBOTSARG_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#robotsargWebsiteSearchBtnId").click(function(){
        ROBOTSARG_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#robotsargWebsiteDataTableId");
        ...
        var keyword = $("#robotsargWebsiteSearchInputId").val();
        var obj = new RobotsArgWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#robotsargWebsiteFilterSearchBtnId").click(function(){
        ROBOTSARG_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "robotsargWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#robotsargWebsiteSearchFilterFormId").serializeArray();
        var obj = new RobotsArgWebsite();
...
$(document).ready(function(){
    var checker = $("#robotsargWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#robotsargWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#robotsargWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#robotsargWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#robotsargWebsiteInlineCreateTableId").find('.robotsarg-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#robotsargWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#robotsargWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#robotsargWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#robotsargWebsiteInlineDetailTableId").find('.robotsarg-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#robotsargWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#robotsargWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#robotsargWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#robotsargWebsiteInlineEditTableId").find('.robotsarg-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#robotsargWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#robotsargWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".robotsarg-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    ROBOTSARG_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#robotsargWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.robotsarg-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#robotsargWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("robotsargWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("robotsargWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var ROBOTSARG_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#robotsargWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "robotsargWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new RobotsArgWebsite();
            $("#robotsargWebsiteInlineTableBodyId").empty();
            var body = $("#robotsargWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
