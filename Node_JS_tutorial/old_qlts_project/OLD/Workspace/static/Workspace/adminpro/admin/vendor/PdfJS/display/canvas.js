  ...
  CanvasGraphics.prototype = {
    ...
    showText: function CanvasGraphics_showText(glyphs) {
      ...
      if (current.patternFill) {
        // : Patterns are not applied correctly to text if a non-embedded
    ...
    beginGroup: function CanvasGraphics_beginGroup(group) {
      ...
      this.save();
      const currentCtx = this.ctx;
      //  non-isolated groups - according to Rik at adobe non-isolated
      ...
      //  knockout - supposedly possible with the clever use of compositing
      // modes.
      if (group.knockout) {
