...
function postFormDataFromTableLogoImagesWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    ...
    $(tableEle).find('tbody>tr').each(function(){
        ...
        try{
            ...
            var tObj = new LogoImagesWebsite();
...
function getDataToInlineTableLogoImagesWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
var genLogoImagesWebsite_FIELDS = [
        "name",
        "uuid",
        "file",
        "is_favicon",
...
var LOGOIMAGES_CACHE = [];
var CURRENT_LogoImagesWebsite = null;
var CURRENT_LOGOIMAGES_UUID = null;
var LOGOIMAGES_WEBSITE_ID_TABLE_COUNT = 1;
var LOGOIMAGES_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class LogoImagesWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#fileLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.file = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#is_faviconLogoImagesWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#descLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#updated_atLogoImagesWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atLogoImagesWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#nameLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#fileLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.file = chEle.val();
            }
            else{
            ...
            var chEle = $("#is_faviconLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.is_favicon = chEle.val();
            }
            else{
            ...
            var chEle = $("#descLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atLogoImagesWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#nameLogoImagesWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidLogoImagesWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_file = formEle.find("[name='file']");
            }
            else{
                var j_ele_file = $("#fileLogoImagesWebsiteInputIdCurrentFileId");
            }
            if (j_ele_file.length > 0){
                if (typeof self.file != "undefined"){
                    j_ele_file.text(" " + self.file.substring(self.file.lastIndexOf('/')+1));
                    j_ele_file.attr("href", self.file);
                    j_ele_file.attr("url", self.file);
                    j_ele_file.attr("data-toggle", "modal");
                    j_ele_file.addClass("current-file-preview");
                }
            }
            else{
                // j_ele_file.val(null);
                console.log('[tFillForm] Not found element...', file);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_is_favicon = formEle.find("[name='is_favicon']");
            }
            else{
                var j_ele_is_favicon = $("#is_faviconLogoImagesWebsiteInputId");
            }
            if (j_ele_is_favicon.length > 0){
                var input_type = j_ele_is_favicon.attr('type');
                console.log("[tFillForm] ", input_type);
                if (input_type == 'checkbox'){
                    if (self.is_favicon == true){
                        j_ele_is_favicon.prop('checked', true);
                    }
                    else {
                        j_ele_is_favicon.prop('checked', false);
                    }
                }
            }
            else{
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_desc = $("#descLogoImagesWebsiteInputId");
            }
        ...
        // ######################
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atLogoImagesWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atLogoImagesWebsiteInputId");
                }
    ...
    tCreatePostApi(targetUrl=null, async_flag=false){
        ...
        var self = this;
        if (targetUrl==null){
            targetUrl = LogoImagesWebsite_URL;
        }
        $.ajax({
            url: targetUrl,
            type: "POST",
            ...
            success: function (data) {
                    self = new LogoImagesWebsite(data);
                    $.confirm({
                        title: 'Info!',
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/LogoImages/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#logoimagesWebsiteEditFormId');
        ...
        var file_eles = $(".logoimages-website");
        for (var i = 0; i < file_eles.length; i++) {
            console.log('file_eles[i] = ', file_eles[i]);
            var files = file_eles[i].files;
            // Check file selected or not
        ...
        if (targetUrl==null){
            targetUrl = LogoImagesWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idLogoImagesWebsiteInputId').val(null);
        $('#uuidLogoImagesWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#logoimagesWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = LogoImagesWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = LogoImagesWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new LogoImagesWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new LogoImagesWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                LOGOIMAGES_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( LOGOIMAGES_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = LogoImagesWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = LogoImagesWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = LogoImagesWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                LOGOIMAGES_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = LogoImagesWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = LogoImagesWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new LogoImagesWebsite(data);
                try{
                ...
                //        var tmp = new LogoImagesWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "LogoImagesWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + LOGOIMAGES_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + LOGOIMAGES_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary logoimages-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning logoimages-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger logoimages-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="logoimages-website-remove-inline-row">
    ...
    tFillList1(listId=null){
        if (listId==null){
            var lsId = "LogoImagesWebsiteListId";
            var lst = $("#" + lsId);
        }
        else{
            var lst = $("#" + listId);
...
class LogoImagesWebsite_ListItem {
    constructor(data){
        if (data != null){
            this.id = data.id;
            this.uuid = data.uuid;
...
var LogoImagesWebsiteList_CACHE = [];
// ########## Get List Class ##############
class LogoImagesWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            url: LogoImagesWebsite_LIST_URL,
            type: "GET",
            async: async_flag,
            cache: false,
            timeout: 30000,
            ...
            success: function (data) {
                LogoImagesWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new LogoImagesWebsite_ListItem(data.results[i]);
                        LogoImagesWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return LogoImagesWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#logoimagesWebsiteDataTableId');
    if (dt.length > 0){
        var logoimagesWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#logoimagesWebsiteCreateBtnId").click(function(){
        obj = new LogoImagesWebsite();
...
$(document).ready( function () {
    $(".logoimages-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new LogoImagesWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("logoimagesWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#logoimagesWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#logoimagesWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_LOGOIMAGES_UUID = null;
        clearForm("logoimagesWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".logoimages-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("logoimagesWebsiteModalDetailFormId");
        $("#" + "logoimagesWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "logoimagesWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#logoimagesWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#logoimagesWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_LOGOIMAGES_UUID = null;
        clearForm("logoimagesWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".logoimages-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("logoimagesWebsiteModalEditFormId");
        $("#" + "logoimagesWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "logoimagesWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#logoimagesWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#logoimagesWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_LOGOIMAGES_UUID = null;
        clearForm("logoimagesWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#logoimagesWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#logoimagesWebsiteUpdateBtnId").click(function(){
        obj = new LogoImagesWebsite();
...
$(document).ready(function(){
    $("#logoimagesWebsiteSaveAndNewBtnId").click(function(){
        obj = new LogoImagesWebsite();
...
$(document).ready(function(){
    $("#logoimagesWebsiteDeleteBtnId").click(function(){
        obj = new LogoImagesWebsite();
...
$(document).ready(function(){
    $("#logoimagesWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTableLogoImagesWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".logoimages-website-inline-delete-button").click(function(){
        var obj = new LogoImagesWebsite();
...
$(document).ready(function(){
    if ($(".logoimages-website-select.autoload").length > 0){
        var obj = new LogoImagesWebsiteList();
        LogoImagesWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < LogoImagesWebsiteList_CACHE.length; l++){
            crr = LogoImagesWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".logoimages-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".logoimages-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".logoimages-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".logoimages-website-select").each(function(event){
...
$(document).ready(function(){
    $(".logoimages-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".logoimages-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".logoimages-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#logoimagesWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestLogoImagesWebsite(formId){
    var b_json = genLogoImagesWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new LogoImagesWebsite(b_json);
    var d_obj = new LogoImagesWebsite(b_json);
    ...
    // var d_obj = new LogoImagesWebsiteList();
...
$(document).ready(function(){
    $("#logoimagesWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "logoimagesWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new LogoImagesWebsite();
            $("#logoimagesWebsiteTableBodyId").empty();
            var body = $("#logoimagesWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            LOGOIMAGES_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#logoimagesWebsiteSearchBtnId").click(function(){
        LOGOIMAGES_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#logoimagesWebsiteDataTableId");
        ...
        var keyword = $("#logoimagesWebsiteSearchInputId").val();
        var obj = new LogoImagesWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#logoimagesWebsiteFilterSearchBtnId").click(function(){
        LOGOIMAGES_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "logoimagesWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#logoimagesWebsiteSearchFilterFormId").serializeArray();
        var obj = new LogoImagesWebsite();
...
$(document).ready(function(){
    var checker = $("#logoimagesWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#logoimagesWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#logoimagesWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#logoimagesWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#logoimagesWebsiteInlineCreateTableId").find('.logoimages-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#logoimagesWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#logoimagesWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#logoimagesWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#logoimagesWebsiteInlineDetailTableId").find('.logoimages-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#logoimagesWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#logoimagesWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#logoimagesWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#logoimagesWebsiteInlineEditTableId").find('.logoimages-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#logoimagesWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#logoimagesWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".logoimages-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    LOGOIMAGES_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#logoimagesWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.logoimages-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#logoimagesWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("logoimagesWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("logoimagesWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var LOGOIMAGES_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#logoimagesWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "logoimagesWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new LogoImagesWebsite();
            $("#logoimagesWebsiteInlineTableBodyId").empty();
            var body = $("#logoimagesWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
