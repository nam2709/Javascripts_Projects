...
function postFormDataFromTableFooterItemWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    ...
    $(tableEle).find('tbody>tr').each(function(){
        ...
        try{
            ...
            var tObj = new FooterItemWebsite();
...
function getDataToInlineTableFooterItemWebsite(tableId,
                                    attr_value=null){
    var tableEle = $("#" + tableId);
    var app_name = $(tableEle).attr('data-app-name');
...
var genFooterItemWebsite_FIELDS = [
        "name",
        "uuid",
        "desc",
        "html_code",
...
function genFooterItemWebsite(){
    ...
    "js_code": makeid(128),
    "order": makeid(),
    "position": genRandomSelect('.position-footeritem-website-option'),
    "active": genBoolean(),
...
var FOOTERITEM_CACHE = [];
var CURRENT_FooterItemWebsite = null;
var CURRENT_FOOTERITEM_UUID = null;
var FOOTERITEM_WEBSITE_ID_TABLE_COUNT = 1;
var FOOTERITEM_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
class FooterItemWebsite{
    ...
    tGetFormData(formId=null){
        var formEle = $("#" + formId);
        if (formEle.length > 0){
            var chEle = formEle.find("#nameFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#uuidFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#descFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = formEle.find("#html_codeFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#css_codeFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#js_codeFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#orderFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#positionFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#activeFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#updated_atFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = formEle.find("#created_atFooterItemWebsiteInputId");
            if (chEle.length > 0){
            ...
            var chEle = $("#idFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.id = chEle.val();
            }
            else{
            ...
            var chEle = $("#nameFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.name = chEle.val();
            }
            else{
            ...
            var chEle = $("#uuidFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.uuid = chEle.val();
            }
            else{
            ...
            var chEle = $("#descFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.desc = chEle.val();
            }
            else{
            ...
            var chEle = $("#html_codeFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.html_code = chEle.val();
            }
            else{
            ...
            var chEle = $("#css_codeFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.css_code = chEle.val();
            }
            else{
            ...
            var chEle = $("#js_codeFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.js_code = chEle.val();
            }
            else{
            ...
            var chEle = $("#orderFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.order = chEle.val();
            }
            else{
            ...
            var chEle = $("#positionFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.position = chEle.val();
            }
            else{
            ...
            var chEle = $("#activeFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.active = chEle.val();
            }
            else{
            ...
            var chEle = $("#updated_atFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.updated_at = chEle.val();
            }
            else{
            ...
            var chEle = $("#created_atFooterItemWebsiteInputId");
            if (chEle.length > 0){
                this.created_at = chEle.val();
            }
            else{
    ...
    tFillForm(formId=null){
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_name = $("#nameFooterItemWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_uuid = $("#uuidFooterItemWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_desc = $("#descFooterItemWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_html_code = formEle.find("[name='html_code']");
            }
            else{
                var j_ele_html_code = $("#html_codeFooterItemWebsiteInputId");
            }
            var this_id = j_ele_html_code.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_html_code.length > 0){
                var tagName = j_ele_html_code.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_html_code.text(self.html_code).change();

                    // For CKEDITOR update
                    if (j_ele_html_code.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.html_code);
                    }
                    break;
        // ######################
                  case "SELECT":
                    var tx = j_ele_html_code;
                    // ManyToMany Field processing
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.html_code)){
                            var tmpArr = self.html_code.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.html_code;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.html_code.hasOwnProperty('uuid')){
                                    $(j_ele_html_code).val(self.html_code.uuid).change();
                                }
                                else{
                                    if (self.html_code.hasOwnProperty('id')){
                                        $(j_ele_html_code).val(self.html_code.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_html_code).val(self.html_code).change();
                ...
                console.log('[tFillForm] Not found element...', html_code);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_css_code = formEle.find("[name='css_code']");
            }
            else{
                var j_ele_css_code = $("#css_codeFooterItemWebsiteInputId");
            }
            var this_id = j_ele_css_code.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_css_code.length > 0){
                var tagName = j_ele_css_code.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_css_code.text(self.css_code).change();

                    // For CKEDITOR update
                    if (j_ele_css_code.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.css_code);
                    }
                    break;
        // ######################
                  case "SELECT":
                    var tx = j_ele_css_code;
                    // ManyToMany Field processing
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.css_code)){
                            var tmpArr = self.css_code.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.css_code;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.css_code.hasOwnProperty('uuid')){
                                    $(j_ele_css_code).val(self.css_code.uuid).change();
                                }
                                else{
                                    if (self.css_code.hasOwnProperty('id')){
                                        $(j_ele_css_code).val(self.css_code.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_css_code).val(self.css_code).change();
                ...
                console.log('[tFillForm] Not found element...', css_code);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_js_code = formEle.find("[name='js_code']");
            }
            else{
                var j_ele_js_code = $("#js_codeFooterItemWebsiteInputId");
            }
            var this_id = j_ele_js_code.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_js_code.length > 0){
                var tagName = j_ele_js_code.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_js_code.text(self.js_code).change();

                    // For CKEDITOR update
                    if (j_ele_js_code.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.js_code);
                    }
                    break;
        // ######################
                  case "SELECT":
                    var tx = j_ele_js_code;
                    // ManyToMany Field processing
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.js_code)){
                            var tmpArr = self.js_code.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.js_code;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.js_code.hasOwnProperty('uuid')){
                                    $(j_ele_js_code).val(self.js_code.uuid).change();
                                }
                                else{
                                    if (self.js_code.hasOwnProperty('id')){
                                        $(j_ele_js_code).val(self.js_code.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_js_code).val(self.js_code).change();
                ...
                console.log('[tFillForm] Not found element...', js_code);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_order = $("#orderFooterItemWebsiteInputId");
            }
        ...
        try{
            if (formEle != null && formEle.length > 0){
                var j_ele_position = formEle.find("[name='position']");
            }
            else{
                var j_ele_position = $("#positionPositionFooterItemWebsiteInputId");
            }
            var this_id = j_ele_position.attr('id');
            console.log('[tFillForm] this_id = ', this_id);
        // ######################
            if (j_ele_position.length > 0){
                var tagName = j_ele_position.prop("tagName");
                console.log('[tFillForm] Tag name = ', tagName);
        ...
        // ######################
                  case "TEXTAREA":
                    j_ele_position.text(self.position).change();

                    // For CKEDITOR update
                    if (j_ele_position.hasClass('ckeditor-input')){
                        var _if = $("#cke_" + this_id).find('iframe');
                        _if.contents().find('body').html(self.position);
                    }
                    break;
        // ######################
                  case "SELECT":
                    var tx = j_ele_position;
                    // ManyToMany Field processing
                    if (typeof tx.attr('multiple') != "undefined"){
                        console.log('[tFillForm][case "SELECT":] Select many2many...');
                        if (Array.isArray(self.position)){
                            var tmpArr = self.position.map(function(elem){
                                if (elem != null && elem.hasOwnProperty('uuid')){
                                    return elem.uuid;
                                }
                                else{
                    ...
                    // Foreign Key process
                        ...
                        try{
                            var se = self.position;
                            if ( typeof se != 'undefined' && se != null ) {
                                if (self.position.hasOwnProperty('uuid')){
                                    $(j_ele_position).val(self.position.uuid).change();
                                }
                                else{
                                    if (self.position.hasOwnProperty('id')){
                                        $(j_ele_position).val(self.position.id).change();
                                    }
                                    else{
                                        // Not object --> set value:
                                        $(j_ele_position).val(self.position).change();
                ...
                console.log('[tFillForm] Not found element...', position);
            }
        }
        catch(err) {
            console.log('err = ', err);
        ...
        try{
            if (formEle != null && formEle.length > 0){
                ...
                var j_ele_active = $("#activeFooterItemWebsiteInputId");
            }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_updated_at = $("#updated_atFooterItemWebsiteInputId");
                }
            ...
            try{
                if (formEle != null && formEle.length > 0){
                    ...
                    var j_ele_created_at = $("#created_atFooterItemWebsiteInputId");
                }
    ...
    tCreatePostApi(targetUrl=null, async_flag=false){
        ...
        var self = this;
        if (targetUrl==null){
            targetUrl = FooterItemWebsite_URL;
        }
        $.ajax({
            url: targetUrl,
            type: "POST",
            ...
            success: function (data) {
                    self = new FooterItemWebsite(data);
                    $.confirm({
                        title: 'Info!',
                        ...
                        buttons: {
                            ...
                            Show: function () {
                                // $.alert('Canceled!');
                                $(location).prop('href', "/Workspace/FooterItem/detail/" + self.uuid + "/" + '?n=' + new Date().getTime());
                            },
                            // somethingElse: {
                            //     text: 'Something else',
                            //     btnClass: 'btn-blue',
    ...
    tUpdatePostApi(targetUrl=null, async_flag=false){
        ...
        var tempForm = $('#footeritemWebsiteEditFormId');
        ...
        var file_eles = $(".footeritem-website");
        for (var i = 0; i < file_eles.length; i++) {
            console.log('file_eles[i] = ', file_eles[i]);
            var files = file_eles[i].files;
            // Check file selected or not
        ...
        if (targetUrl==null){
            targetUrl = FooterItemWebsite_URL + self.uuid + "/";
        }
        $.ajax({
            url: targetUrl,
            // type: "PUT",
    ...
    tCreateNewPostFormApi(formId=null, targetUrl=null, async_flag=false){
        ...
        $('#idFooterItemWebsiteInputId').val(null);
        $('#uuidFooterItemWebsiteInputId').val(uuidv4());
        var self = this;
        if (formId == null){
            var tempForm = $('#footeritemWebsiteCreateFormId')
        }
        else{
            var tempForm = $('#' + formId);
        }
    ...
    tGetAllObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            if ($.isNumeric(page)){
                targetUrl = FooterItemWebsite_URL + "?page=" + page;
            }
            else{
                targetUrl = FooterItemWebsite_URL;
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // return new FooterItemWebsite(data);
                if (data.hasOwnProperty('results')){
                    for (var j=0; j < data.results.length; j++){
                        var tmp = new FooterItemWebsite(data.results[j]);
                        results.push(tmp);
                        if (fill_table == true){
                            if (tableId == null){
                                tmp.tFillTable2();
                                FOOTERITEM_WEBSITE_ID_TABLE_COUNT++;
                            }
                            else{
                    ...
                    if (data.hasOwnProperty('next') && data.next !== null && $.isNumeric(page) == false){
                        ...
                        if ( FOOTERITEM_WEBSITE_ID_TABLE_COUNT < 1000){
                            this.url = data.next;
                            $.ajax(this);
                        }
                    }
    ...
    tGetInlineObjApi(targetUrl=null,
        ...
        if (targetUrl==null){
            targetUrl = FooterItemWebsite_INLINE_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tSearchAllObjApi(keyword,
        ...
        if (targetUrl==null){
            targetUrl = FooterItemWebsite_SEARCH_URL + "?search=" + keyword + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
    ...
    tFilterSearchAllObjApi(search_data=null,
        ...
        if (targetUrl==null){
            targetUrl = FooterItemWebsite_FILTER_SEARCH_URL + "?page=" + page;
        }
        $.ajax({
            url: targetUrl,
            type: "GET",
                    ...
                    for (var j=0; j < data.results.length; j++){
                        ...
                        if (fill_table == true){
                            if (tableId == null){
                                ...
                                FOOTERITEM_WEBSITE_ID_INLINE_TABLE_COUNT++;
                            }
                        }
                    }
                    if (data.hasOwnProperty('next') && data.next !== null){
    ...
    tGetObjApi(uuid, targetUrl=null, async_flag=false){
        ...
        if (targetUrl == null){
            if (uuid != null){
                targetUrl = FooterItemWebsite_URL + uuid + "/";
            }
            else{
                if(this.uuid != null){
                    targetUrl = FooterItemWebsite_URL + this.uuid + "/";
                }
                else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var n_obj = new FooterItemWebsite(data);
                try{
                ...
                //        var tmp = new FooterItemWebsite(data.results[i]);
                //        return tmp;
                //    }
                //}
            },
    ...
    tFillTable1(tableId=null){
        if (tableId==null){
            var tbId = "FooterItemWebsiteDataTableId";
            var table = $("#" + tbId);
        }
        else{
            var table = $("#" + tableId);
    ...
    tFillTable2(tableId=null,
        ...
        if (table.length > 0){
            ...
            if (inlineMode == false){
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + FOOTERITEM_WEBSITE_ID_TABLE_COUNT + `</a>`,
                ];
            }
            else{
                var rowData = [
                    `<a href="` + this.detailUrl + `">` + FOOTERITEM_WEBSITE_ID_INLINE_TABLE_COUNT + `</a>`,
                ];
            }
            ...
            if (inlineMode == false){
                var action_string = (`<a class="btn btn-primary footeritem-website-uuid-detail-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="View"><i class="far fa-eye"></i></a>
                <a class="btn btn-warning footeritem-website-uuid-edit-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Edit"><i class="far fa-edit"></i></a>
                <a class="btn btn-danger footeritem-website-uuid-delete-button" title="" data-uuid="` + this.uuid + `" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>`);
            }
            else{
                var action_string = (`
                    <a class="footeritem-website-remove-inline-row">
    ...
    tFillList1(listId=null){
        if (listId==null){
            var lsId = "FooterItemWebsiteListId";
            var lst = $("#" + lsId);
        }
        else{
            var lst = $("#" + listId);
...
class FooterItemWebsite_ListItem {
    constructor(data){
        if (data != null){
            this.id = data.id;
            this.uuid = data.uuid;
...
var FooterItemWebsiteList_CACHE = [];
// ########## Get List Class ##############
class FooterItemWebsiteList {
    // ########## Init Objects ##############
    getListApi(async_flag=false){
        ...
        $.ajax({
            url: FooterItemWebsite_LIST_URL,
            type: "GET",
            async: async_flag,
            cache: false,
            timeout: 30000,
            ...
            success: function (data) {
                FooterItemWebsiteList_CACHE = []
                console.log(data);
                if (data.hasOwnProperty('results')){
                    for (var i = 0; i < data.results.length; i++){
                        var x = new FooterItemWebsite_ListItem(data.results[i]);
                        FooterItemWebsiteList_CACHE.push(x);
                    }
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
        ...
        return FooterItemWebsiteList_CACHE;
    }

}
$(document).ready( function () {
    // $.noConflict();
    var dt = $('#footeritemWebsiteDataTableId');
    if (dt.length > 0){
        var footeritemWebsiteDataTable = $(dt[0]).DataTable({
...
$(document).ready(function(){
    $("#footeritemWebsiteCreateBtnId").click(function(){
        obj = new FooterItemWebsite();
...
$(document).ready( function () {
    $(".footeritem-website-modal-create-button").click(function(){
        console.log('Class clicked...');
        // var crr_obj = new FooterItemWebsite();
        // crr_obj = crr_obj.tGetObjApi($(this).attr('data-uuid'));
        // crr_obj.tFillForm("footeritemWebsiteModalDetailFormId");
        console.log('[$(".%s-modal-create-button").click] Get done...');
    })

    $("#footeritemWebsiteCreateModalId").on('show.bs.modal', function (event) {
        console.log("CreateModalId...shown....");
    })
});
$(document).ready( function () {
    $("#footeritemWebsiteCreateModalId").on('hidden.bs.modal', function (event) {
        console.log("CreateModalId...hidden....");
        CURRENT_FOOTERITEM_UUID = null;
        clearForm("footeritemWebsiteModalCreateFormId");
    })
});
$(document).ready( function () {
    $(".footeritem-website-modal-detail-button").click(function(){
        ...
        crr_obj.tFillForm("footeritemWebsiteModalDetailFormId");
        $("#" + "footeritemWebsiteModalDetailFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-detail-button").click] Get done...');

        // Load datatables
        $("#" + "footeritemWebsiteModalDetailFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })
    $("#footeritemWebsiteModalDetailFormId").on('show.bs.modal', function (event) {
        console.log('[$(".%s-modal-detail-button").click] DetailModalFormId...shown....');
    })
});
$(document).ready( function () {
    $("#footeritemWebsiteModalDetailId").on('hidden.bs.modal', function (event) {
        console.log("ModalDetailId...hidden....");
        CURRENT_FOOTERITEM_UUID = null;
        clearForm("footeritemWebsiteModalDetailFormId");
    })
});
$(document).ready( function () {
    $(".footeritem-website-modal-edit-button").click(function(){
        ...
        crr_obj = crr_obj.tGetObjApi(crr_uuid);
        crr_obj.tFillForm("footeritemWebsiteModalEditFormId");
        $("#" + "footeritemWebsiteModalEditFormId").attr('data-uuid', crr_uuid);
        console.log('[$(".%s-modal-edit-button").click] Get done...');

        // Load datatables
        $("#" + "footeritemWebsiteModalEditFormId").find('table').each(function () {
            var tableId = $(this).attr('id');
            tLoadDetailInlineTable(tableId);
        });
    })

    $("#footeritemWebsiteEditModalFormId").on('show.bs.modal', function (event) {
        console.log("EditModalFormId...shown....");
    })
});
$(document).ready( function () {
    $("#footeritemWebsiteEditModalFormId").on('hidden.bs.modal', function (event) {
        console.log("EditModalFormId...hidden....");
        CURRENT_FOOTERITEM_UUID = null;
        clearForm("footeritemWebsiteEditModalFormId");
    })
});
// ########## [Edit Button] Clicked Handle function ##############
$(document).ready(function(){
    $("#footeritemWebsiteEditBtnId").click(function(){
...
$(document).ready(function(){
    $("#footeritemWebsiteUpdateBtnId").click(function(){
        obj = new FooterItemWebsite();
...
$(document).ready(function(){
    $("#footeritemWebsiteSaveAndNewBtnId").click(function(){
        obj = new FooterItemWebsite();
...
$(document).ready(function(){
    $("#footeritemWebsiteDeleteBtnId").click(function(){
        obj = new FooterItemWebsite();
...
$(document).ready(function(){
    $("#footeritemWebsiteInlineSaveBtnId").click(function(){
        var targetId = $(this).attr('data-target');
        postFormDataFromTableFooterItemWebsite(targetId);
    })
});
// ########## [Delete Inline Button] Clicked Handle function ##############
$(document).ready(function(){
    $(".footeritem-website-inline-delete-button").click(function(){
        var obj = new FooterItemWebsite();
...
$(document).ready(function(){
    if ($(".footeritem-website-select.autoload").length > 0){
        var obj = new FooterItemWebsiteList();
        FooterItemWebsiteList_CACHE = obj.getListApi(async_flag=false);
        var crr = null;
        for (l = 0; l < FooterItemWebsiteList_CACHE.length; l++){
            crr = FooterItemWebsiteList_CACHE[l]
            // $(this).append(new Option(crr.name, crr.uuid));
            if ($(".footeritem-website-select option[value=" + crr.uuid + "]").length > 0){
            // if ($(".footeritem-website-select option[value=" + crr.id + "]").length > 0){
                console.log('[.%s-%s-select.autoload] Existed... ignore option...', crr);
            }
            else{
                 $(".footeritem-website-select").each(function(event){
                     $(this).append(new Option(crr.name, crr.uuid));
                 })
                // $(".footeritem-website-select").each(function(event){
...
$(document).ready(function(){
    $(".footeritem-website-uuid-delete-button").click(function(){
...
$(document).ready(function(){
    $(".footeritem-website-uuid-modal-detail-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
...
$(document).ready(function(){
    $(".footeritem-website-uuid-modal-edit-button").click(function(){
        var cr_uuid = $(this).attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false){
...
$(document).ready(function(){
    //$("#footeritemWebsiteEditModalFormId").click(function(){
    //    var cr_uuid = $(this).attr('data-uuid');
...
// ########## tTest function ##############
function tTestFooterItemWebsite(formId){
    var b_json = genFooterItemWebsite();
    console.log("b_json = ", b_json);
    // var d_obj = new FooterItemWebsite(b_json);
    var d_obj = new FooterItemWebsite(b_json);
    ...
    // var d_obj = new FooterItemWebsiteList();
...
$(document).ready(function(){
    $("#footeritemWebsiteReloadBtnId").click(function(){
        var checker = $("#" + "footeritemWebsiteTableBodyId");
        if (checker.length > 0){
            var obj = new FooterItemWebsite();
            $("#footeritemWebsiteTableBodyId").empty();
            var body = $("#footeritemWebsiteDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
            }
            FOOTERITEM_WEBSITE_ID_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $("#footeritemWebsiteSearchBtnId").click(function(){
        FOOTERITEM_WEBSITE_ID_TABLE_COUNT = 1;
        var table = $("#footeritemWebsiteDataTableId");
        ...
        var keyword = $("#footeritemWebsiteSearchInputId").val();
        var obj = new FooterItemWebsite
...
// ########## [Search Button] Handle Event function ##############
$(document).ready(function(){
    $("#footeritemWebsiteFilterSearchBtnId").click(function(){
        FOOTERITEM_WEBSITE_ID_TABLE_COUNT = 1;
        var tableId = "footeritemWebsiteDataTableId";
        var table = $("#" + tableId);
        // var body = table.find('tbody').empty();
        try {
            var dt = table.DataTable();
        ...
        var search_data = $("#footeritemWebsiteSearchFilterFormId").serializeArray();
        var obj = new FooterItemWebsite();
...
$(document).ready(function(){
    var checker = $("#footeritemWebsiteFormId");
    if (checker.length > 0){
    ...
    checker = $("#footeritemWebsiteDetailFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
    ...
    checker = $("#footeritemWebsiteEditFormId");
    if (checker.length > 0){
        var cr_uuid = checker.attr('data-uuid');
        if (typeof cr_uuid !== 'undefined' && cr_uuid !== false && cr_uuid !== ""){
...
$(document).ready(function(){
    $("#footeritemWebsiteInlineCreateAddRowBtnId").click(function(){
        var htmls = $("#footeritemWebsiteInlineCreateTableId").find('.footeritem-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#footeritemWebsiteInlineCreateTableId tbody').append(html);
            var row_ids = $('#footeritemWebsiteInlineCreateTableId .inline-row-id');
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#footeritemWebsiteInlineDetailAddRowBtnId").click(function(){
        var htmls = $("#footeritemWebsiteInlineDetailTableId").find('.footeritem-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#footeritemWebsiteInlineDetailTableId tbody').append(html);
            var row_ids = $('#footeritemWebsiteInlineDetailTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
// ########## [Inline Add Row] Clicked Handle function ##############
$(document).ready(function(){
    $("#footeritemWebsiteInlineEditAddRowBtnId").click(function(){
        var htmls = $("#footeritemWebsiteInlineEditTableId").find('.footeritem-website-inline-row');
        if (htmls.length > 0){
            var html = htmls[1].outerHTML;
            // console.log(html);
            $('#footeritemWebsiteInlineEditTableId tbody').append(html);
            var row_ids = $('#footeritemWebsiteInlineEditTableId .inline-row-id');
            console.log('row_ids = ', row_ids);
            for (var x = 0; x <row_ids.length; x++){
                row_ids[x].text = x+1;
            }
...
$(document).ready(function(){
    $(document).on('click', ".footeritem-website-remove-inline-row", function(){
...
function tLoadDetailInlineTable(inlineTableId){
    ...
    dataTable.rows().remove().draw();
    FOOTERITEM_WEBSITE_ID_INLINE_TABLE_COUNT = 1;
...
$(document).ready(function(){
    $(document).on('click', "#footeritemWebsiteInlineDetailDownloadBtnId", function(){
...
$(document).ready(function(){
    $('tr.footeritem-website-inline-row').focusout( 'click', function () {
...
$(document).ready(function(){
    $("#footeritemWebsiteInlineDetailTableId").ready(function(){
        var ele = document.getElementById("footeritemWebsiteInlineDetailTableId");
        if (ele != null && isInViewport(ele) == true){
            tLoadDetailInlineTable("footeritemWebsiteInlineDetailTableId");
        }
    })
})
// ########## [Fill Inline Table] Handle Event function ##############
var FOOTERITEM_ID_INLINE_TABLE_COUNT = 1;
$(document).ready(function(){
    $("#footeritemWebsiteReloadInlineBtnId").click(function(){
        var checker = $("#" + "footeritemWebsiteInlineTableBodyId");
        if (checker.length > 0){
            var obj = new FooterItemWebsite();
            $("#footeritemWebsiteInlineTableBodyId").empty();
            var body = $("#footeritemWebsiteInlineDataTableId");
            if (body.length > 0){
                // $.noConflict();
                var bodyTable = body.DataTable();
                bodyTable.clear();
