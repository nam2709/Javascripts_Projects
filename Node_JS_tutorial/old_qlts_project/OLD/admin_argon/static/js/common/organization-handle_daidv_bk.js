        ...
        for (var i = 0; i < arr_remove.length; i++) {
         ...
         if (organization_id !== null && organization_id !== 'null' && organization_id !== ''){
            console.log(organization_id)
             A360UnitSelfRelatedChangeEvent(or_id=organization_id, or_code=or_code);
//             A360UnitSelfRelatedChangeTitleEvent(or_code=organization_id);
         }
...
function A360UnitSelfRelatedChangeEvent(or_id=null, or_code=null){
