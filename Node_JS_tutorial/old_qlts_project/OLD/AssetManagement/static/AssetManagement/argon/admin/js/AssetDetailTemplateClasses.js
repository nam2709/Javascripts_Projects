...
var AssetDetailTemplate_arr_action = [
    // default action
    {
        "title": "Xem chi tiết",
        "func": "AssetDetailTemplateDetails",
        "icon": "far fa-eye",
        "href": "#",
        "isCheck": false,
    ...
    {
        "title": "Xóa",
        "func": "AssetDetailTemplateOnDeleteEvent",
...
// Actions functions
function AssetDetailTemplateDetails(uuid) {
    $('#AssetDetailTemplateDetailmodalsId').modal('toggle');
    var obj = new AssetDetailTemplate();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new AssetDetailTemplate(data).tFillFormModal('Detail', 'AssetDetailTemplateDetailModalsFormId');

    })
    //obj.tFillFormModal('Detail');
}

function AssetDetailTemplateEdit(uuid) {
    $('#AssetDetailTemplateEditmodalsId').modal('toggle');
    var obj = new AssetDetailTemplate();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new AssetDetailTemplate(data).tFillFormModal('Edit', 'AssetDetailTemplateEditModalsFormId');

    })
    //obj.tFillFormModal('Edit');
}

function AssetDetailTemplateOnDeleteEvent(uuid) {
    ...
    if (search_data == null) {
        ...
        AssetDetailTemplateOnDeleteWithDataSearchEvent(uuid);
    }

}
function AssetDetailTemplateOnDeleteWithDataSearchEvent(uuid) {
    $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?',
...
function AssetDetailTemplateViewDetail(selectionId) {
...
class AssetDetailTemplate {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            this.__model_name__ = "AssetDetailTemplate";
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameAssetDetailTemplateInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#uuidAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#codeAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buyAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#unitAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.unit = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#owned_companyAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_byAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_byAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#codeAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = $("#nameAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = $("#uuidAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = $("#price_buyAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#unitAssetDetailTemplateInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#owned_companyAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_byAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_byAssetDetailTemplateInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_name = $("#nameAssetDetailTemplateInputId");
        ...
        try {
            var j_ele_uuid = $("#uuidAssetDetailTemplateInputId");
        ...
        try {
            var j_ele_tndid = $("#codeAssetDetailTemplateInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeAssetDetailTemplateInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        var self = this;
        try {
            var j_ele_name = $("#nameAssetDetailTemplate" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_code = $("#dcodeAssetDetailTemplate" + apart + "InputId");
        ...
        try {
            var j_ele_uuid = $("#uuidAssetDetailTemplate" + apart + "InputId");
        ...
        //fill modal edit
        try {
            var j_ele_asset_type = $("#asset_typeAssetDetailTemplate" + apart + "InputId");
            if (j_ele_asset_type.length > 0) {
                if (j_ele_asset_type.attr('name') != 'uuid') {
                    j_ele_asset_type.val(self.asset_type).change();
                }
        ...
        // fill modal detail`
        try {
            var j_ele_asset_type = $("#name_asset_typeAssetDetailTemplate" + apart + "InputId");
            if (j_ele_asset_type.length > 0) {
                if (j_ele_asset_type.attr('name') != 'uuid') {
        ...
        // fill modal edit
        try {
            var j_ele_own_status = $("#own_statusAssetDetailTemplate" + apart + "InputId");
        ...
        // fill modal detail
        try {
            var j_ele_own_status = $("#name_own_statusAssetDetailTemplate" + apart + "InputId");
            if (j_ele_own_status.length > 0) {
                if (j_ele_own_status.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_price_buy = $("#price_buyAssetDetailTemplate" + apart + "InputId");
            if (j_ele_price_buy.length > 0) {
                if (j_ele_price_buy.attr('name') != 'uuid') {
                    j_ele_price_buy.val(self.price_buy).change();
                }
        ...
        try {
            var j_ele_date_added = $("#date_addedAssetDetailTemplate" + apart + "InputId");
        ...
        //fill modail edit
        try {
            var j_ele_warehouse = $("#warehouseAssetDetailTemplate" + apart + "InputId");
        ...
        // fill modal detail
        try {
            var j_ele_warehouse = $("#name_warehouseAssetDetailTemplate" + apart + "InputId");
            if (j_ele_warehouse.length > 0) {
                if (j_ele_warehouse.attr('name') != 'uuid') {
        ...
        // fill modal edit
        try {
            var j_ele_supplier = $("#supplierAssetDetailTemplate" + apart + "InputId");
        ...
        // fill modal detail
        try {
            var j_ele_supplier = $("#name_supplierAssetDetailTemplate" + apart + "InputId");
            if (j_ele_supplier.length > 0) {
                if (j_ele_supplier.attr('name') != 'uuid') {
        ...
        //fill modal edit
        try {
            var j_ele_asset_status = $("#asset_statusAssetDetailTemplate" + apart + "InputId");
        ...
        //fill modal detail
        try {
            var j_ele_asset_status = $("#name_asset_statusAssetDetailTemplate" + apart + "InputId");
            if (j_ele_asset_status.length > 0) {
                if (j_ele_asset_status.attr('name') != 'uuid') {
        ...
        // fill modal edit
        try {
            var j_ele_unit = $("#unitAssetDetailTemplate" + apart + "InputId");
        ...
        //fill modal detail
        try {
            var j_ele_unit = $("#name_unitAssetDetailTemplate" + apart + "InputId");
            if (j_ele_unit.length > 0) {
                if (j_ele_unit.attr('name') != 'uuid') {
        ...
        // fill modal edit
        try {
            var j_ele_owned_company = $("#owned_companyAssetDetailTemplate" + apart + "InputId");
        ...
        // fill modal detail
        try {
            var j_ele_owned_company = $("#name_owned_companyAssetDetailTemplate" + apart + "InputId");
            if (j_ele_owned_company.length > 0) {
                if (j_ele_owned_company.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_updated_at = $("#updated_atAssetDetailTemplate" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atAssetDetailTemplate" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
    ...
    tCreatePostApi() {
        ...
        $.ajax({
            url: AssetDetailTemplate_API_URL,
            type: "POST",
            async: false,
            cache: false,
            timeout: 30000,
            ...
            success: function (data) {
                self = new AssetDetailTemplate(data);
    ...
    tUpdatePostApi(formId = null) {
        ...
        var arr_table = [];
        if (formId == null) {
            formData = new FormData($('#AssetDetailTemplateCreateFormId')[0]);
        ...
        console.log(idForm)
        $.ajax({
            url: AssetDetailTemplate_API_URL + idForm + "/",
            // type: "PUT",
            type: "PATCH",
            async: false,
            cache: false,
            ...
            success: function (data) {
                ...
                AssetDetailTemplateGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
    ...
    tDeleteApi(uuid = null) {
        ...
        $.ajax({
            url: AssetDetailTemplate_API_URL + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: AssetDetailTemplate_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    if (data.hasOwnProperty('results')) {
                        for (var j = 0; j < data.results.length; j++) {
                            var tmp = new AssetDetailTemplate(data.results[j]);
                            results.push(tmp);
                        }
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = AssetDetailTemplate_FILTER_URL;

            slugSearch = "&";

            if ($("#nameAssetDetailTemplateFilterSearchInputId").length > 0) {
                var value = $("#nameAssetDetailTemplateFilterSearchInputId").val();
                if (value != "" && value != null) {
            ...
            SEARCH_URL = AssetDetailTemplate_Search_URL;

            slugSearch = "&";
            slugSearch += "search=" + $("#AssetDetailTemplateQuickSearchInputId").val();
    ...
    tGetObjApi(uuid) {
        ...
        this.callAjax =
            $.ajax({
                url: AssetDetailTemplate_API_URL + uuid + "/",
                type: "GET",
                async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    var n_obj = new AssetDetailTemplate(data);
    ...
    tFillTable3(tableId = null, order = null) {
        var tbId = "AssetDetailTemplateDataTableId";
        if (tableId != null) {
            tbId = tableId;
        }

        if (order == null) {
            order = ASSETDETAILTEMPLATE_ID_TABLE_COUNT;
        }
        var table = $("#" + tbId);
        if (table.length > 0) {
            var html = "<tr>"
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if (attr == "name") {
                        html += `<td class="text-wrap" style="min-width:300px" onclick="AssetDetailTemplateDetails('` + this["uuid"] + `')"><a>` + (this[attr]) + `</a></td>`;
                        continue;
                    }
                    ...
                    if (attr == "asset-admin-action") {
                        html += BindActionButtonVer4(
                            AssetDetailTemplate_arr_action,
                            this["uuid"],
                            this,
                            null,
                            this["created_by"],
...
// fill table function
function AssetDetailTemplateGetDataTable(page = 1, search_data = null) {
    search_log["search_func"] = "AssetDetailTemplateGetDataTable";
    ...
    obj.callAjax.then(function (data) {
        ...
        var body = $("#AssetDetailTemplateDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        ASSETDETAILTEMPLATE_ID_TABLE_COUNT = 1;
        var crr_record_in_page = AccountAccountrecord_in_page;

        if (page > 1) {
            ASSETDETAILTEMPLATE_ID_TABLE_COUNT = 1 + crr_record_in_page * page - crr_record_in_page
        }
        for (var i = 0; i < results.length; i++) {
            try {
                ...
                ASSETDETAILTEMPLATE_ID_TABLE_COUNT++;
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateGetDataTable(1)">Đầu</a></li>`);
            if (pagination["has_prev"] == true) {
                pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
            }
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "AssetDetailTemplateDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "AssetDetailTemplateDetailModalsFormId";
    AssetDetailTemplateViewDetail(selectionId)
})

// [Save Create] Clicked Handle function
$(document).ready(function () {
    $("#AssetDetailTemplateCreateModalBtnId").click(function () {
        var validate_obj = new InputValidation('AssetDetailTemplateCreateModalsFormId');
        if (validate_obj.validateRequired()) {
            toastr.warning('Vui lòng điền đầy đủ thông tin');
            return;
        }
        obj = new AssetDetailTemplate();
        console.log('Save obj = ', obj);
        obj.tCreateNewPostFormApi('AssetDetailTemplateCreateModalsFormId');
    })
});

// [SAVE UPDATE]
$(document).ready(function () {
    $("#AssetDetailTemplateUpdateModalBtnId").click(function () {
        obj = new AssetDetailTemplate();
        obj.tUpdatePostApi('AssetDetailTemplateEditModalsFormId');
    })
});
    ...
    for (var i = 1; i < 2; i++) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#" + InputId + "AssetDetailTemplate" + apart + "ModalInputId").append(html);
            }
        });
    }
}
...
// Export excel
$(document).ready(function () {
    $('#AssetDetailTemplateExportExcelBtnId').click(function () {
        // Define the columns to export
        var columnsToExport = [0, 1, 2, 3, 4, 5, 6]; // columns 1, 2, and 4 (zero-indexed)
        var theadToExport = '';
        $('#AssetDetailTemplateDataTableId thead').each(function () {
            var row = '';
        ...
        var tbodyToExport = '';
        $('#AssetDetailTemplateDataTableId tbody tr').each(function () {
            var row = '';
...
function AssetDetailTemplateSearchData(page = 1, search_type, search_data = null) {
    search_log["search_func"] = "AssetDetailTemplateSearchData";
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);

            if (pagination["has_prev"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateSearchData(` + (parseInt(pagination["current_page"]) - 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
            }
            pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
            if (pagination["has_next"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateSearchData(` + (parseInt(pagination["current_page"]) + 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetDetailTemplateSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
        if (search_type == "quick") {
            var crr_txt = $("#AssetDetailTemplateQuickSearchInputId").val();
            highlight(crr_txt, "#AssetDetailTemplateTableBodyId");
        }
    })
...
$(document).ready(function () {
    $("#AssetDetailTemplateQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            AssetDetailTemplateSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    $("#AssetDetailTemplateQuickSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
    ...
    $("#AssetDetailTemplateSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
        ...
        AssetDetailTemplateSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search