...
var AssetStatus_arr_action = [
    // default action
    {
        "title": "Xem chi tiết",
        "func": "AssetStatusDetails",
        "icon": "far fa-eye",
        "href": "#",
        "isCheck": false,
...
// Actions functions
function AssetStatusDetails(uuid) {
    $('#AssetStatusDetailmodalsId').modal('toggle');
    var obj = new AssetStatus();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new AssetStatus(data).tFillFormModal('Detail', 'AssetStatusDetailModalsFormId');

    })
    //obj.tFillFormModal('Detail');
}

function AssetStatusEdit(uuid) {
    $('#AssetStatusEditmodalsId').modal('toggle');
    var obj = new AssetStatus();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new AssetStatus(data).tFillFormModal('Edit', 'AssetStatusEditModalsFormId');

    })
    //obj.tFillFormModal('Edit');
}

function AssetStatusOnDeleteEvent(uuid) {
    ...
    if (search_data == null) {
        ...
        AssetStatusOnDeleteWithDataSearchEvent(uuid);
    }

}
function AssetStatusOnDeleteWithDataSearchEvent(uuid) {
    $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?',
...
function AssetStatusViewDetail(selectionId) {
...
class AssetStatus {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            this.__model_name__ = "AssetStatus";
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameAssetStatusInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#uuidAssetStatusInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#codeAssetStatusInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buyAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#unitAssetStatusInputId");
            if (chEle.length > 0) {
                this.unit = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#owned_companyAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_byAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_byAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#codeAssetStatusInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = $("#nameAssetStatusInputId");
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = $("#uuidAssetStatusInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = $("#price_buyAssetStatusInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedAssetStatusInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeAssetStatusInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseAssetStatusInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierAssetStatusInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusAssetStatusInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusAssetStatusInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#unitAssetStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#owned_companyAssetStatusInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atAssetStatusInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atAssetStatusInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_byAssetStatusInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_byAssetStatusInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_name = $("#nameAssetStatusInputId");
        ...
        try {
            var j_ele_uuid = $("#uuidAssetStatusInputId");
        ...
        try {
            var j_ele_tndid = $("#codeAssetStatusInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeAssetStatusInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        var self = this;
        try {
            var j_ele_name = $("#nameAssetStatus" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_code = $("#dcodeAssetStatus" + apart + "InputId");
        ...
        try {
            var j_ele_uuid = $("#uuidAssetStatus" + apart + "InputId");
        ...
        //fill modal edit
        try {
            var j_ele_detail_description = $("#detail_descriptionAssetStatus" + apart + "InputId");
            if (j_ele_detail_description.length > 0) {
                if (j_ele_detail_description.attr('name') != 'uuid') {
                    j_ele_detail_description.val(self.detail_description).change();
                }
            }
            else {
                // j_ele_nick_name.val(null);
        ...
        try {
            var j_ele_updated_at = $("#updated_atAssetStatus" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atAssetStatus" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_by = $("#created_byAssetStatus" + apart + "InputId");
            if (j_ele_created_by.length > 0) {
                if (j_ele_created_by.attr('created_by') != 'uuid') {
    ...
    tUpdatePostApi(formId = null) {
        ...
        var arr_table = [];
        if (formId == null) {
            formData = new FormData($('#AssetStatusCreateFormId')[0]);
        ...
        console.log(idForm)
        $.ajax({
            url: AssetStatus_API_URL + idForm + "/",
            // type: "PUT",
            type: "PATCH",
            async: false,
            cache: false,
            ...
            success: function (data) {
                ...
                AssetStatusGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.warning('Mã mã tình trạng thiết bị đã tồn tại');
                console.log(xhr.status);
                console.log(thrownError);
                if (xhr.textStatus == 'timeout') {
                    this.tryCount++;
    ...
    tDeleteApi(uuid = null) {
        ...
        $.ajax({
            url: AssetStatus_API_URL + uuid_go + "/",
            type: "DELETE",
            async: false,
            cache: false,
            timeout: 30000,
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: AssetStatus_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    if (data.hasOwnProperty('results')) {
                        for (var j = 0; j < data.results.length; j++) {
                            var tmp = new AssetStatus(data.results[j]);
                            results.push(tmp);
                        }
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = AssetStatus_FILTER_URL;

            slugSearch = "&";

            if ($("#nameAssetStatusFilterSearchInputId").length > 0) {
                var value = $("#nameAssetStatusFilterSearchInputId").val();
                if (value != "" && value != null) {
            ...
            SEARCH_URL = AssetStatus_Search_URL;

            slugSearch = "&";
            slugSearch += "search=" + $("#AssetStatusQuickSearchInputId").val();
        ...
        this.callAjax =
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var n_obj = new AssetStatus(data);
    ...
    tFillTable3(tableId = null, order = null) {
        var tbId = "AssetStatusDataTableId";
        if (tableId != null) {
            tbId = tableId;
        }

        if (order == null) {
            order = AssetStatus_ID_TABLE_COUNT;
        }
        var table = $("#" + tbId);
        if (table.length > 0) {
            var html = "<tr>"
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if (attr == "name") {
                        html += `<td class="text-wrap" style="min-width:300px" onclick="AssetStatusDetails('` + this["uuid"] + `')"><a>` + (this[attr]) + `</a></td>`;
                        continue;
                    }
...
// fill table function
function AssetStatusGetDataTable(page = 1, search_data = null) {
    search_log["search_func"] = "AssetStatusGetDataTable";
    ...
    obj.callAjax.then(function (data) {
        $("#AssetStatusTableBodyId").empty();
        var body = $("#AssetStatusDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        AssetStatus_ID_TABLE_COUNT = 1;
        var crr_record_in_page = AccountAccountrecord_in_page;

        if (page > 1) {
            AssetStatus_ID_TABLE_COUNT = 1 + crr_record_in_page * page - crr_record_in_page
        }
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetStatusGetDataTable(1)">Đầu</a></li>`);
            if (pagination["has_prev"] == true) {
                pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="AssetStatusGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
            }
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetStatusGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "AssetStatusDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "AssetStatusDetailModalsFormId";
    AssetStatusViewDetail(selectionId)
})

// [Save Create] Clicked Handle function
$(document).ready(function () {
    $("#AssetStatusCreateModalBtnId").click(function () {
        var validate_obj = new InputValidation('AssetStatusCreateModalsFormId');
        ...
        obj.tCreateNewPostFormApi('AssetStatusCreateModalsFormId');
    })
});

// [SAVE UPDATE]
$(document).ready(function () {
    $("#AssetStatusUpdateModalBtnId").click(function () {
        obj = new AssetStatus();
        obj.tUpdatePostApi('AssetStatusEditModalsFormId');
    })
});

// Export excel
$(document).ready(function () {
    $('#AssetStatusExportExcelBtnId').click(function () {
        // Define the columns to export
        var columnsToExport = [0, 1, 2, 3]; // columns 1, 2, and 4 (zero-indexed)
        var theadToExport = '';
        $('#AssetStatusDataTableId thead').each(function () {
            var row = '';
        ...
        var tbodyToExport = '';
        $('#AssetStatusDataTableId tbody tr').each(function () {
            var row = '';
        ...
        $(tempTable).tableExport({
            filename: 'thông_tin_tình_trạng_thiết_bị_%DD%-%MM%-%YY%',
            format: 'xls',
            escape: 'false',
...
function AssetStatusSearchData(page = 1, search_type, search_data = null) {
    search_log["search_func"] = "AssetStatusSearchData";
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetStatusSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);

            if (pagination["has_prev"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetStatusSearchData(` + (parseInt(pagination["current_page"]) - 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
            }
            pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
            if (pagination["has_next"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetStatusSearchData(` + (parseInt(pagination["current_page"]) + 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="AssetStatusSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
        if (search_type == "quick") {
            var crr_txt = $("#AssetStatusQuickSearchInputId").val();
            highlight(crr_txt, "#AssetStatusTableBodyId");
        }
    })
...
$(document).ready(function () {
    $("#AssetStatusQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            AssetStatusSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    $("#AssetStatusQuickSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
    ...
    $("#AssetStatusSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
        ...
        AssetStatusSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search
...
function CheckUnique(dcode) {
    ...
    $.ajax({
        url: AssetStatus_Search_URL + slugSearch,
        dataType: 'JSON',
        type: 'GET',
        success: function (data) {
            if (data.results.length > 0) {
