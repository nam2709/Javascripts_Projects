...
var OwnStatus_arr_action = [
    // default action
    {
        "title": "Xem chi tiết",
        "func": "OwnStatusDetails",
        "icon": "far fa-eye",
        "href": "#",
        "isCheck": false,
...
// Actions functions
function OwnStatusDetails(uuid) {
    $('#OwnStatusDetailmodalsId').modal('toggle');
    var obj = new OwnStatus();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new OwnStatus(data).tFillFormModal('Detail', 'OwnStatusDetailModalsFormId');

    })
    //obj.tFillFormModal('Detail');
}

function OwnStatusEdit(uuid) {
    $('#OwnStatusEditmodalsId').modal('toggle');
    var obj = new OwnStatus();
    obj.tGetObjApi(uuid);
    obj.callAjax.then(function (data) {
        new OwnStatus(data).tFillFormModal('Edit', 'OwnStatusEditModalsFormId');

    })
    //obj.tFillFormModal('Edit');
}

function OwnStatusOnDeleteEvent(uuid) {
    ...
    if (search_data == null) {
        ...
        OwnStatusOnDeleteWithDataSearchEvent(uuid);
    }

}
function OwnStatusOnDeleteWithDataSearchEvent(uuid) {
    $.confirm({
        icon: 'fa fa-smile-o',
        title: 'XÓA!',
        content: 'Bạn có chắc muốn xóa ?',
...
function OwnStatusViewDetail(selectionId) {
...
class OwnStatus {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            if (data.hasOwnProperty('uuid')) {
                this.uuid = data.uuid;
                this.editUrl = '/AssetManagement/OwnStatus/edit/' + this.uuid + '/';
                this.detailUrl = '/AssetManagement/OwnStatus/detail/' + this.uuid + '/';
            }
            else {
                // this.uuid = null;
            }
    ...
    tGetFormData(formId = null) {
        var formEle = $("#" + formId);
        if (formEle.length > 0) {
            var chEle = formEle.find("#nameOwnStatusInputId"); //Kiêrm tra giá trị của form id name
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#uuidOwnStatusInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#codeOwnStatusInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#price_buyOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#date_addedOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_typeOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#warehouseOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#supplierOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#own_statusOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#asset_statusOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#unitOwnStatusInputId");
            if (chEle.length > 0) {
                this.unit = chEle.val();
            }
            else {
            ...
            var chEle = formEle.find("#owned_companyOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_atOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_atOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#created_byOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = formEle.find("#updated_byOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#codeOwnStatusInputId");
            if (chEle.length > 0) {
                this.code = chEle.val();
            }
            else {
            ...
            var chEle = $("#nameOwnStatusInputId");
            if (chEle.length > 0) {
                this.name = chEle.val();
            }
            else {
            ...
            var chEle = $("#uuidOwnStatusInputId");
            if (chEle.length > 0) {
                this.uuid = chEle.val();
            }
            else {
            ...
            var chEle = $("#price_buyOwnStatusInputId");
            if (chEle.length > 0) {
                this.price_buy = chEle.val();
            }
            else {
            ...
            var chEle = $("#date_addedOwnStatusInputId");
            if (chEle.length > 0) {
                this.date_added = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_typeOwnStatusInputId");
            if (chEle.length > 0) {
                this.asset_type = chEle.val();
            }
            else {
            ...
            var chEle = $("#warehouseOwnStatusInputId");
            if (chEle.length > 0) {
                this.warehouse = chEle.val();
            }
            else {
            ...
            var chEle = $("#supplierOwnStatusInputId");
            if (chEle.length > 0) {
                this.supplier = chEle.val();
            }
            else {
            ...
            var chEle = $("#own_statusOwnStatusInputId");
            if (chEle.length > 0) {
                this.own_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#asset_statusOwnStatusInputId");
            if (chEle.length > 0) {
                this.asset_status = chEle.val();
            }
            else {
            ...
            var chEle = $("#unitOwnStatusInputId");
            if (chEle.length > 0) {
            ...
            var chEle = $("#owned_companyOwnStatusInputId");
            if (chEle.length > 0) {
                this.owned_company = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_atOwnStatusInputId");
            if (chEle.length > 0) {
                this.created_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_atOwnStatusInputId");
            if (chEle.length > 0) {
                this.updated_at = chEle.val();
            }
            else {
            ...
            var chEle = $("#created_byOwnStatusInputId");
            if (chEle.length > 0) {
                this.created_by = chEle.val();
            }
            else {
            ...
            var chEle = $("#updated_byOwnStatusInputId");
            if (chEle.length > 0) {
                this.updated_by = chEle.val();
            }
            else {
    ...
    tFillForm() {
        ...
        try {
            var j_ele_name = $("#nameOwnStatusInputId");
        ...
        try {
            var j_ele_uuid = $("#uuidOwnStatusInputId");
        ...
        try {
            var j_ele_tndid = $("#codeOwnStatusInputId");
        ...
        try {
            var j_ele_asset_type = $("#asset_typeOwnStatusInputId");
    ...
    tFillFormModal(modals_type, formId = null) {
        ...
        var self = this;
        try {
            var j_ele_name = $("#nameOwnStatus" + apart + "InputId");
            if (j_ele_name.length > 0) {
                if (j_ele_name.attr('name') != 'uuid') {
        ...
        try {
            var j_ele_code = $("#dcodeOwnStatus" + apart + "InputId");
        ...
        try {
            var j_ele_uuid = $("#uuidOwnStatus" + apart + "InputId");
        ...
        try {
            var j_ele_detail_description = $("#detail_descriptionOwnStatus" + apart + "InputId");
        ...
        try {
            var j_ele_updated_at = $("#updated_atOwnStatus" + apart + "InputId");
            if (j_ele_updated_at.length > 0) {
                var dateObj = new Date(Date.parse(self.updated_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_at = $("#created_atOwnStatus" + apart + "InputId");
            if (j_ele_created_at.length > 0) {
                var dateObj = new Date(Date.parse(self.created_at));
                if (dateObj != "Invalid Date") {
                    var newdate = moment(dateObj).format('DD/MM/YYYY');
        ...
        try {
            var j_ele_created_by = $("#created_byOwnStatus" + apart + "InputId");
    ...
    tUpdatePostApi(formId = null) {
        ...
        var arr_table = [];
        if (formId == null) {
            formData = new FormData($('#OwnStatusCreateFormId')[0]);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                OwnStatusGetDataTable(AccountAccountpagination["current_page"]);
                //$(location).prop('href', "/Account/Account/detail/" + self.uuid + "/");
                $('.modal').modal('hide');
                // self.tFillForm();
            },
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.warning('Mã trạng thái sở hữu đã tồn tại');
                console.log(xhr.status);
                console.log(thrownError);
                if (xhr.textStatus == 'timeout') {
                    this.tryCount++;
    ...
    tGetAllObjApi(page = null, search_data = null) {
        ...
        this.callAjax =
            $.ajax({
                ...
                url: OwnStatus_API_URL + has_go_page,
                type: "GET",
                //async: false,
                cache: false,
                timeout: 30000,
                ...
                success: function (data) {
                    ...
                    if (data.hasOwnProperty('results')) {
                        for (var j = 0; j < data.results.length; j++) {
                            var tmp = new OwnStatus(data.results[j]);
                            results.push(tmp);
                        }
    ...
    tSearchAllObjApi(page = null, search_data = null, typeSearch) {
        ...
        if (typeSearch == "filter") {
            SEARCH_URL = OwnStatus_FILTER_URL;

            slugSearch = "&";

            if ($("#nameOwnStatusFilterSearchInputId").length > 0) {
                var value = $("#nameOwnStatusFilterSearchInputId").val();
                if (value != "" && value != null) {
            ...
            SEARCH_URL = OwnStatus_Search_URL;

            slugSearch = "&";
            slugSearch += "search=" + $("#OwnStatusQuickSearchInputId").val();
    ...
    tFillTable3(tableId = null, order = null) {
        var tbId = "OwnStatusDataTableId";
        if (tableId != null) {
            tbId = tableId;
        }

        if (order == null) {
            order = OwnStatus_ID_TABLE_COUNT;
        }
        var table = $("#" + tbId);
        if (table.length > 0) {
            var html = "<tr>"
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if (attr == "name") {
                        html += `<td class="text-wrap" style="min-width:300px" onclick="OwnStatusDetails('` + this["uuid"] + `')"><a>` + (this[attr]) + `</a></td>`;
                        continue;
                    }
...
// fill table function
function OwnStatusGetDataTable(page = 1, search_data = null) {
    search_log["search_func"] = "OwnStatusGetDataTable";
    ...
    obj.callAjax.then(function (data) {
        $("#OwnStatusTableBodyId").empty();
        var body = $("#OwnStatusDataTableId");
        //if (body.length > 0){
        //    var bodyTable = body.DataTable();
        //    bodyTable.clear();
        //}
        OwnStatus_ID_TABLE_COUNT = 1;
        var crr_record_in_page = AccountAccountrecord_in_page;

        if (page > 1) {
            OwnStatus_ID_TABLE_COUNT = 1 + crr_record_in_page * page - crr_record_in_page
        }
        ...
        if (results.length > 0) {
            ...
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="OwnStatusGetDataTable(1)">Đầu</a></li>`);
            if (pagination["has_prev"] == true) {
                pagenation_ele.append('<li class="page-item"><a class="page-link" onclick="OwnStatusGetDataTable(' + (parseInt(pagination["current_page"]) - 1) + ')">' + (parseInt(pagination["current_page"]) - 1) + '</a></li>');
            }
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="OwnStatusGetDataTable(` + last_page_order + `)">Cuối</a></li>`);
            }
        }
    })
}
...
$(document).ready(function () {
    var IdTable = "OwnStatusDataTableId";
    var checker = $("#" + IdTable);
    if (checker.length > 0) {
...
$(document).ready(function () {
    var selectionId = "OwnStatusDetailModalsFormId";
    OwnStatusViewDetail(selectionId)
})

// [Save Create] Clicked Handle function
$(document).ready(function () {
    $("#OwnStatusCreateModalBtnId").click(function () {
        var validate_obj = new InputValidation('OwnStatusCreateModalsFormId');
        ...
        obj.tCreateNewPostFormApi('OwnStatusCreateModalsFormId');
    })
});

// [SAVE UPDATE]
$(document).ready(function () {
    $("#OwnStatusUpdateModalBtnId").click(function () {
        obj = new OwnStatus();
        obj.tUpdatePostApi('OwnStatusEditModalsFormId');
    })
});

// Export excel
$(document).ready(function () {
    $('#OwnStatusExportExcelBtnId').click(function () {
        // Define the columns to export
        var columnsToExport = [0, 1, 2, 3]; // columns 1, 2, and 4 (zero-indexed)
        var theadToExport = '';
        $('#OwnStatusDataTableId thead').each(function () {
            var row = '';
        ...
        var tbodyToExport = '';
        $('#OwnStatusDataTableId tbody tr').each(function () {
            var row = '';
        ...
        $(tempTable).tableExport({
            filename: 'thông_tin_trạng_thái_sử_dụng_%DD%-%MM%-%YY%',
            format: 'xls',
            escape: 'false',
...
function OwnStatusSearchData(page = 1, search_type, search_data = null) {
    search_log["search_func"] = "OwnStatusSearchData";
    ...
    obj.callAjax.then(function (data) {
        ...
        if (results.length > 0) {
            pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="OwnStatusSearchData(1,'` + search_type + `'` + `,'` + search_data + `'` + `)">Đầu</a></li>`);

            if (pagination["has_prev"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="OwnStatusSearchData(` + (parseInt(pagination["current_page"]) - 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) - 1) + `</a></li>`);
            }
            pagenation_ele.append('<li class="page-item active"><a class="page-link" >' + (parseInt(pagination["current_page"])) + '</a></li>');
            if (pagination["has_next"] == true) {
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="OwnStatusSearchData(` + (parseInt(pagination["current_page"]) + 1) + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">` + (parseInt(pagination["current_page"]) + 1) + `</a></li>`);
            ...
            if (pagination["total"] > 0) {
                ...
                pagenation_ele.append(`<li class="page-item"><a class="page-link" onclick="OwnStatusSearchData(` + last_page_order + `,'` + search_type + `'` + `,'` + search_data + `'` + `)">Cuối</a></li>`);
            }
        }
        if (search_type == "quick") {
            var crr_txt = $("#OwnStatusQuickSearchInputId").val();
            highlight(crr_txt, "#OwnStatusTableBodyId");
        }
    })
...
$(document).ready(function () {
    $("#OwnStatusQuickSearchInputId").on('keyup', function (e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            OwnStatusSearchData(AccountAccountpagination["current_page"], "quick");
        }
    })
    $("#OwnStatusQuickSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
    ...
    $("#OwnStatusSearchBtnId").click(function () {
        AccountAccountpagination = {
            current_page: 1,
            total: 0,
            has_next: false,
        ...
        OwnStatusSearchData(AccountAccountpagination["current_page"], "filter");
    })
});
// END Search
...
function CheckUnique(dcode) {
    ...
    $.ajax({
        url: OwnStatus_Search_URL + slugSearch,
        dataType: 'JSON',
        type: 'GET',
        success: function (data) {
            if (data.results.length > 0) {
